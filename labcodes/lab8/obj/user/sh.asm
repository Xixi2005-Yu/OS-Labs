...
0000000000800020 <__panic>:
  ...
  800054:	d8850513          	addi	a0,a0,-632 # 800dd8 <main+0x146>
...
0000000000800062 <__warn>:
  ...
  800096:	d4650513          	addi	a0,a0,-698 # 800dd8 <main+0x146>
...
0000000000800134 <exit>:
  ...
  800140:	c6450513          	addi	a0,a0,-924 # 800da0 <main+0x10e>
...
00000000008001e6 <cprintf>:
  ...
  800206:	ad958593          	addi	a1,a1,-1319 # ffffffffffff6ad9 <shcwd+0xffffffffff7f29d1>
...
0000000000800906 <readline>:
  ...
  800926:	4505                	li	a0,1
  800928:	93bff0ef          	jal	ra,800262 <fprintf>
  ...
  80094a:	4501                	li	a0,0
  80094c:	82bff0ef          	jal	ra,800176 <read>
  ...
  80096e:	4505                	li	a0,1
  800970:	8f3ff0ef          	jal	ra,800262 <fprintf>
  ...
  80098a:	fecff0ef          	jal	ra,800176 <read>
  ...
  8009ba:	4505                	li	a0,1
  8009bc:	8a7ff0ef          	jal	ra,800262 <fprintf>
  ...
  8009d6:	4505                	li	a0,1
  8009d8:	88bff0ef          	jal	ra,800262 <fprintf>
...
00000000008009fc <reopen>:
  ...
  800a0c:	f68ff0ef          	jal	ra,800174 <close>
  800a10:	8522                	mv	a0,s0
  800a12:	85ca                	mv	a1,s2
  800a14:	f5aff0ef          	jal	ra,80016e <open>
  ...
  800a3c:	f38ff0ef          	jal	ra,800174 <close>
  800a40:	85a6                	mv	a1,s1
  800a42:	8522                	mv	a0,s0
  800a44:	f36ff0ef          	jal	ra,80017a <dup2>
...
0000000000800a54 <runcmd>:
  ...
  800af0:	e5aff0ef          	jal	ra,80014a <fork>
  800af4:	87aa                	mv	a5,a0
  800af6:	14051763          	bnez	a0,800c44 <runcmd+0x1f0>
  800afa:	e7aff0ef          	jal	ra,800174 <close>
  800afe:	4581                	li	a1,0
  800b00:	4501                	li	a0,0
  800b02:	e78ff0ef          	jal	ra,80017a <dup2>
  800b06:	842a                	mv	s0,a0
  800b08:	04054c63          	bltz	a0,800b60 <runcmd+0x10c>
  800b0c:	4501                	li	a0,0
  800b0e:	e66ff0ef          	jal	ra,800174 <close>
  800b12:	4501                	li	a0,0
  800b14:	e60ff0ef          	jal	ra,800174 <close>
  ...
  800b58:	4505                	li	a0,1
  800b5a:	f08ff0ef          	jal	ra,800262 <fprintf>
  800b5e:	547d                	li	s0,-1
  ...
  800bd8:	4581                	li	a1,0
  800bda:	d94ff0ef          	jal	ra,80016e <open>
  800bde:	87aa                	mv	a5,a0
  800be0:	02054263          	bltz	a0,800c04 <runcmd+0x1b0>
  800be4:	d90ff0ef          	jal	ra,800174 <close>
  ...
  800bfc:	d52ff0ef          	jal	ra,80014e <__exec>
  ...
  800c3a:	4505                	li	a0,1
  800c3c:	e26ff0ef          	jal	ra,800262 <fprintf>
  800c40:	547d                	li	s0,-1
  800c42:	bf39                	j	800b60 <runcmd+0x10c>
  800c44:	fc0543e3          	bltz	a0,800c0a <runcmd+0x1b6>
  800c48:	4505                	li	a0,1
  800c4a:	d2aff0ef          	jal	ra,800174 <close>
  800c4e:	4585                	li	a1,1
  800c50:	4501                	li	a0,0
  800c52:	d28ff0ef          	jal	ra,80017a <dup2>
  800c56:	87aa                	mv	a5,a0
  800c58:	fa0549e3          	bltz	a0,800c0a <runcmd+0x1b6>
  800c5c:	4501                	li	a0,0
  800c5e:	d16ff0ef          	jal	ra,800174 <close>
  800c62:	4501                	li	a0,0
  800c64:	d10ff0ef          	jal	ra,800174 <close>
...
0000000000800c92 <main>:
  ...
  800ca8:	d7aff0ef          	jal	ra,800222 <cputs>
  800cac:	4789                	li	a5,2
  ...
  800d02:	4505                	li	a0,1
  800d04:	d5eff0ef          	jal	ra,800262 <fprintf>
  ...
  800d24:	4505                	li	a0,1
  800d26:	d3cff0ef          	jal	ra,800262 <fprintf>
  800d2a:	557d                	li	a0,-1
  ...
  800d56:	bdeff0ef          	jal	ra,800134 <exit>
