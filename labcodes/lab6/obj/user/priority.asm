...
main(void) {
  ...
  8006b4:	6985                	lui	s3,0x1
               lab6_setpriority(i + 1);
  8006b6:	aa9ff0ef          	jal	ra,80015e <lab6_setpriority>
                    if(acc[i]%4000==0) {
  8006ba:	fa04849b          	addiw	s1,s1,-96
               acc[i] = 0;
  8006be:	00042023          	sw	zero,0(s0)
                        if((time=gettime_msec())>MAX_TIME) {
  8006c2:	77098993          	addi	s3,s3,1904 # 1770 <_start-0x7fe8b0>
  ...
  800732:	40a60613          	addi	a2,a2,1034 # 800b38 <error_string+0x160>
  800736:	04b00593          	li	a1,75
  80073a:	00000517          	auipc	a0,0x0
  80073e:	40e50513          	addi	a0,a0,1038 # 800b48 <error_string+0x170>
