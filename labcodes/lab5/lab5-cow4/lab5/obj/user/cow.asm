...
exit(int error_code) {
  ...
  8000d4:	4b850513          	addi	a0,a0,1208 # 800588 <main+0x8c>
...
int main(void)
{
  ...
  800502:	bddff0ef          	jal	ra,8000de <fork>
    if (pid < 0) {
  800506:	04054063          	bltz	a0,800546 <main+0x4a>
        cprintf("fork failed\n");
        return -1;
    }
    if (pid == 0) {
  80050a:	c531                	beqz	a0,800556 <main+0x5a>
        global_var = 100;
  ...
  800510:	00001417          	auipc	s0,0x1
  800514:	af040413          	addi	s0,s0,-1296 # 801000 <global_var>
  800518:	400c                	lw	a1,0(s0)
  80051a:	00000517          	auipc	a0,0x0
  80051e:	3ee50513          	addi	a0,a0,1006 # 800908 <error_string+0x118>
  800522:	b1fff0ef          	jal	ra,800040 <cprintf>
        global_var = 200;
  800526:	0c800793          	li	a5,200
        cprintf("parent: wrote global = %d\n", global_var);
  80052a:	0c800593          	li	a1,200
  80052e:	00000517          	auipc	a0,0x0
  800532:	40250513          	addi	a0,a0,1026 # 800930 <error_string+0x140>
        global_var = 200;
  800536:	c01c                	sw	a5,0(s0)
        cprintf("parent: wrote global = %d\n", global_var);
  ...
  80053e:	60a2                	ld	ra,8(sp)
  800540:	6402                	ld	s0,0(sp)
  800542:	0141                	addi	sp,sp,16
  800544:	8082                	ret
        cprintf("fork failed\n");
  800546:	00000517          	auipc	a0,0x0
  80054a:	37250513          	addi	a0,a0,882 # 8008b8 <error_string+0xc8>
  80054e:	af3ff0ef          	jal	ra,800040 <cprintf>
        return -1;
  800552:	557d                	li	a0,-1
  800554:	b7ed                	j	80053e <main+0x42>
        cprintf("child: initial global = %d\n", global_var);
  800556:	00001417          	auipc	s0,0x1
  80055a:	aaa40413          	addi	s0,s0,-1366 # 801000 <global_var>
  80055e:	400c                	lw	a1,0(s0)
  800560:	00000517          	auipc	a0,0x0
  800564:	36850513          	addi	a0,a0,872 # 8008c8 <error_string+0xd8>
  800568:	ad9ff0ef          	jal	ra,800040 <cprintf>
        global_var = 100;
  80056c:	06400793          	li	a5,100
        cprintf("child: wrote global = %d\n", global_var);
  800570:	06400593          	li	a1,100
  800574:	00000517          	auipc	a0,0x0
  800578:	37450513          	addi	a0,a0,884 # 8008e8 <error_string+0xf8>
        global_var = 100;
  80057c:	c01c                	sw	a5,0(s0)
        cprintf("child: wrote global = %d\n", global_var);
  80057e:	ac3ff0ef          	jal	ra,800040 <cprintf>
        exit(0);
  800582:	4501                	li	a0,0
  800584:	b45ff0ef          	jal	ra,8000c8 <exit>
