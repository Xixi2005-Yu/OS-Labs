...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	5e7030ef          	jal	ra,ffffffffc0203e48 <memset>
    dtb_init();
...
ffffffffc0200072:	e2a58593          	addi	a1,a1,-470 # ffffffffc0203e98 <etext+0x2>
ffffffffc0200076:	00004517          	auipc	a0,0x4
ffffffffc020007a:	e4250513          	addi	a0,a0,-446 # ffffffffc0203eb8 <etext+0x22>
...
ffffffffc0200096:	572030ef          	jal	ra,ffffffffc0203608 <proc_init>
...
ffffffffc02000a2:	7b4030ef          	jal	ra,ffffffffc0203856 <cpu_idle>
...
ffffffffc02000c0:	e0450513          	addi	a0,a0,-508 # ffffffffc0203ec0 <etext+0x2a>
...
ffffffffc0200186:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc0200188:	09d030ef          	jal	ra,ffffffffc0203a24 <vprintfmt>
    return cnt;
}
...
ffffffffc02001bc:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001be:	067030ef          	jal	ra,ffffffffc0203a24 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001e2:	cea50513          	addi	a0,a0,-790 # ffffffffc0203ec8 <etext+0x32>
{
...
ffffffffc02001f8:	cf450513          	addi	a0,a0,-780 # ffffffffc0203ee8 <etext+0x52>
ffffffffc02001fc:	f99ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200200:	00004597          	auipc	a1,0x4
ffffffffc0200204:	c9658593          	addi	a1,a1,-874 # ffffffffc0203e96 <etext>
ffffffffc0200208:	00004517          	auipc	a0,0x4
ffffffffc020020c:	d0050513          	addi	a0,a0,-768 # ffffffffc0203f08 <etext+0x72>
...
ffffffffc0200220:	d0c50513          	addi	a0,a0,-756 # ffffffffc0203f28 <etext+0x92>
...
ffffffffc0200234:	d1850513          	addi	a0,a0,-744 # ffffffffc0203f48 <etext+0xb2>
...
ffffffffc0200262:	d0a50513          	addi	a0,a0,-758 # ffffffffc0203f68 <etext+0xd2>
}
...
ffffffffc0200270:	d2c60613          	addi	a2,a2,-724 # ffffffffc0203f98 <etext+0x102>
ffffffffc0200274:	04900593          	li	a1,73
ffffffffc0200278:	00004517          	auipc	a0,0x4
ffffffffc020027c:	d3850513          	addi	a0,a0,-712 # ffffffffc0203fb0 <etext+0x11a>
{
...
ffffffffc020028c:	d4060613          	addi	a2,a2,-704 # ffffffffc0203fc8 <etext+0x132>
ffffffffc0200290:	00004597          	auipc	a1,0x4
ffffffffc0200294:	d5858593          	addi	a1,a1,-680 # ffffffffc0203fe8 <etext+0x152>
ffffffffc0200298:	00004517          	auipc	a0,0x4
ffffffffc020029c:	d5850513          	addi	a0,a0,-680 # ffffffffc0203ff0 <etext+0x15a>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002aa:	d5a60613          	addi	a2,a2,-678 # ffffffffc0204000 <etext+0x16a>
ffffffffc02002ae:	00004597          	auipc	a1,0x4
ffffffffc02002b2:	d7a58593          	addi	a1,a1,-646 # ffffffffc0204028 <etext+0x192>
ffffffffc02002b6:	00004517          	auipc	a0,0x4
ffffffffc02002ba:	d3a50513          	addi	a0,a0,-710 # ffffffffc0203ff0 <etext+0x15a>
ffffffffc02002be:	ed7ff0ef          	jal	ra,ffffffffc0200194 <cprintf>
ffffffffc02002c2:	00004617          	auipc	a2,0x4
ffffffffc02002c6:	d7660613          	addi	a2,a2,-650 # ffffffffc0204038 <etext+0x1a2>
ffffffffc02002ca:	00004597          	auipc	a1,0x4
ffffffffc02002ce:	d8e58593          	addi	a1,a1,-626 # ffffffffc0204058 <etext+0x1c2>
ffffffffc02002d2:	00004517          	auipc	a0,0x4
ffffffffc02002d6:	d1e50513          	addi	a0,a0,-738 # ffffffffc0203ff0 <etext+0x15a>
...
ffffffffc0200310:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204068 <etext+0x1d2>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200332:	d6250513          	addi	a0,a0,-670 # ffffffffc0204090 <etext+0x1fa>
...
ffffffffc020035c:	d6090913          	addi	s2,s2,-672 # ffffffffc02040b8 <etext+0x222>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200360:	00004497          	auipc	s1,0x4
ffffffffc0200364:	d6048493          	addi	s1,s1,-672 # ffffffffc02040c0 <etext+0x22a>
        if (argc == MAXARGS - 1) {
ffffffffc0200368:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020036a:	00004b17          	auipc	s6,0x4
ffffffffc020036e:	d5eb0b13          	addi	s6,s6,-674 # ffffffffc02040c8 <etext+0x232>
        argv[argc ++] = buf;
ffffffffc0200372:	00004a17          	auipc	s4,0x4
ffffffffc0200376:	c76a0a13          	addi	s4,s4,-906 # ffffffffc0203fe8 <etext+0x152>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	24d030ef          	jal	ra,ffffffffc0203dee <strcmp>
...
ffffffffc02003b4:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003b6:	239030ef          	jal	ra,ffffffffc0203dee <strcmp>
...
ffffffffc02003f4:	23f030ef          	jal	ra,ffffffffc0203e32 <strchr>
...
ffffffffc0200432:	201030ef          	jal	ra,ffffffffc0203e32 <strchr>
...
ffffffffc0200450:	c9c50513          	addi	a0,a0,-868 # ffffffffc02040e8 <etext+0x252>
...
ffffffffc0200746:	660030ef          	jal	ra,ffffffffc0203da6 <strlen>
...
ffffffffc0200752:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc0200754:	6b8030ef          	jal	ra,ffffffffc0203e0c <strncmp>
...
ffffffffc02007ea:	604030ef          	jal	ra,ffffffffc0203dee <strcmp>
...
ffffffffc0200bee:	00f6ec63          	bltu	a3,a5,ffffffffc0200c06 <interrupt_handler+0x84>
        break;
    default:
        print_trapframe(tf);
        break;
...
ffffffffc0200bfc:	ae850513          	addi	a0,a0,-1304 # ffffffffc02046e0 <commands+0x5e0>
...
ffffffffc0200c0e:	ac650513          	addi	a0,a0,-1338 # ffffffffc02046d0 <commands+0x5d0>
...
ffffffffc0200c24:	8406b823          	sd	zero,-1968(a3) # ffffffffc020d470 <ticks>
             if (num >= 10) {
ffffffffc0200c28:	46a5                	li	a3,9
    num++;
ffffffffc0200c2a:	0017861b          	addiw	a2,a5,1
ffffffffc0200c2e:	c310                	sw	a2,0(a4)
             if (num >= 10) {
ffffffffc0200c30:	fcc6d1e3          	bge	a3,a2,ffffffffc0200bf2 <interrupt_handler+0x70>
	SBI_CALL_0(SBI_SHUTDOWN);
...
ffffffffc0200c50:	c7c70713          	addi	a4,a4,-900 # ffffffffc02048c8 <commands+0x7c8>
...
ffffffffc0200e96:	b4e63603          	ld	a2,-1202(a2) # ffffffffc02059e0 <nbase>
...
ffffffffc02010dc:	83068693          	addi	a3,a3,-2000 # ffffffffc0204908 <commands+0x808>
ffffffffc02010e0:	00004617          	auipc	a2,0x4
ffffffffc02010e4:	83860613          	addi	a2,a2,-1992 # ffffffffc0204918 <commands+0x818>
ffffffffc02010e8:	0f000593          	li	a1,240
ffffffffc02010ec:	00004517          	auipc	a0,0x4
ffffffffc02010f0:	84450513          	addi	a0,a0,-1980 # ffffffffc0204930 <commands+0x830>
ffffffffc02010f4:	b66ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc02010f8:	00004697          	auipc	a3,0x4
ffffffffc02010fc:	8d068693          	addi	a3,a3,-1840 # ffffffffc02049c8 <commands+0x8c8>
ffffffffc0201100:	00004617          	auipc	a2,0x4
ffffffffc0201104:	81860613          	addi	a2,a2,-2024 # ffffffffc0204918 <commands+0x818>
ffffffffc0201108:	0bd00593          	li	a1,189
ffffffffc020110c:	00004517          	auipc	a0,0x4
ffffffffc0201110:	82450513          	addi	a0,a0,-2012 # ffffffffc0204930 <commands+0x830>
ffffffffc0201114:	b46ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0201118:	00004697          	auipc	a3,0x4
ffffffffc020111c:	8d868693          	addi	a3,a3,-1832 # ffffffffc02049f0 <commands+0x8f0>
ffffffffc0201120:	00003617          	auipc	a2,0x3
ffffffffc0201124:	7f860613          	addi	a2,a2,2040 # ffffffffc0204918 <commands+0x818>
ffffffffc0201128:	0be00593          	li	a1,190
ffffffffc020112c:	00004517          	auipc	a0,0x4
ffffffffc0201130:	80450513          	addi	a0,a0,-2044 # ffffffffc0204930 <commands+0x830>
ffffffffc0201134:	b26ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201138:	00004697          	auipc	a3,0x4
ffffffffc020113c:	8f868693          	addi	a3,a3,-1800 # ffffffffc0204a30 <commands+0x930>
ffffffffc0201140:	00003617          	auipc	a2,0x3
ffffffffc0201144:	7d860613          	addi	a2,a2,2008 # ffffffffc0204918 <commands+0x818>
ffffffffc0201148:	0c000593          	li	a1,192
ffffffffc020114c:	00003517          	auipc	a0,0x3
ffffffffc0201150:	7e450513          	addi	a0,a0,2020 # ffffffffc0204930 <commands+0x830>
ffffffffc0201154:	b06ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201158:	00004697          	auipc	a3,0x4
ffffffffc020115c:	96068693          	addi	a3,a3,-1696 # ffffffffc0204ab8 <commands+0x9b8>
ffffffffc0201160:	00003617          	auipc	a2,0x3
ffffffffc0201164:	7b860613          	addi	a2,a2,1976 # ffffffffc0204918 <commands+0x818>
ffffffffc0201168:	0d900593          	li	a1,217
ffffffffc020116c:	00003517          	auipc	a0,0x3
ffffffffc0201170:	7c450513          	addi	a0,a0,1988 # ffffffffc0204930 <commands+0x830>
ffffffffc0201174:	ae6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201178:	00003697          	auipc	a3,0x3
ffffffffc020117c:	7f068693          	addi	a3,a3,2032 # ffffffffc0204968 <commands+0x868>
ffffffffc0201180:	00003617          	auipc	a2,0x3
ffffffffc0201184:	79860613          	addi	a2,a2,1944 # ffffffffc0204918 <commands+0x818>
ffffffffc0201188:	0d200593          	li	a1,210
ffffffffc020118c:	00003517          	auipc	a0,0x3
ffffffffc0201190:	7a450513          	addi	a0,a0,1956 # ffffffffc0204930 <commands+0x830>
ffffffffc0201194:	ac6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 3);
ffffffffc0201198:	00004697          	auipc	a3,0x4
ffffffffc020119c:	91068693          	addi	a3,a3,-1776 # ffffffffc0204aa8 <commands+0x9a8>
ffffffffc02011a0:	00003617          	auipc	a2,0x3
ffffffffc02011a4:	77860613          	addi	a2,a2,1912 # ffffffffc0204918 <commands+0x818>
ffffffffc02011a8:	0d000593          	li	a1,208
ffffffffc02011ac:	00003517          	auipc	a0,0x3
ffffffffc02011b0:	78450513          	addi	a0,a0,1924 # ffffffffc0204930 <commands+0x830>
ffffffffc02011b4:	aa6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011b8:	00004697          	auipc	a3,0x4
ffffffffc02011bc:	8d868693          	addi	a3,a3,-1832 # ffffffffc0204a90 <commands+0x990>
ffffffffc02011c0:	00003617          	auipc	a2,0x3
ffffffffc02011c4:	75860613          	addi	a2,a2,1880 # ffffffffc0204918 <commands+0x818>
ffffffffc02011c8:	0cb00593          	li	a1,203
ffffffffc02011cc:	00003517          	auipc	a0,0x3
ffffffffc02011d0:	76450513          	addi	a0,a0,1892 # ffffffffc0204930 <commands+0x830>
ffffffffc02011d4:	a86ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02011d8:	00004697          	auipc	a3,0x4
ffffffffc02011dc:	89868693          	addi	a3,a3,-1896 # ffffffffc0204a70 <commands+0x970>
ffffffffc02011e0:	00003617          	auipc	a2,0x3
ffffffffc02011e4:	73860613          	addi	a2,a2,1848 # ffffffffc0204918 <commands+0x818>
ffffffffc02011e8:	0c200593          	li	a1,194
ffffffffc02011ec:	00003517          	auipc	a0,0x3
ffffffffc02011f0:	74450513          	addi	a0,a0,1860 # ffffffffc0204930 <commands+0x830>
ffffffffc02011f4:	a66ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 != NULL);
ffffffffc02011f8:	00004697          	auipc	a3,0x4
ffffffffc02011fc:	90868693          	addi	a3,a3,-1784 # ffffffffc0204b00 <commands+0xa00>
ffffffffc0201200:	00003617          	auipc	a2,0x3
ffffffffc0201204:	71860613          	addi	a2,a2,1816 # ffffffffc0204918 <commands+0x818>
ffffffffc0201208:	0f800593          	li	a1,248
ffffffffc020120c:	00003517          	auipc	a0,0x3
ffffffffc0201210:	72450513          	addi	a0,a0,1828 # ffffffffc0204930 <commands+0x830>
ffffffffc0201214:	a46ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201218:	00004697          	auipc	a3,0x4
ffffffffc020121c:	8d868693          	addi	a3,a3,-1832 # ffffffffc0204af0 <commands+0x9f0>
ffffffffc0201220:	00003617          	auipc	a2,0x3
ffffffffc0201224:	6f860613          	addi	a2,a2,1784 # ffffffffc0204918 <commands+0x818>
ffffffffc0201228:	0df00593          	li	a1,223
ffffffffc020122c:	00003517          	auipc	a0,0x3
ffffffffc0201230:	70450513          	addi	a0,a0,1796 # ffffffffc0204930 <commands+0x830>
ffffffffc0201234:	a26ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201238:	00004697          	auipc	a3,0x4
ffffffffc020123c:	85868693          	addi	a3,a3,-1960 # ffffffffc0204a90 <commands+0x990>
ffffffffc0201240:	00003617          	auipc	a2,0x3
ffffffffc0201244:	6d860613          	addi	a2,a2,1752 # ffffffffc0204918 <commands+0x818>
ffffffffc0201248:	0dd00593          	li	a1,221
ffffffffc020124c:	00003517          	auipc	a0,0x3
ffffffffc0201250:	6e450513          	addi	a0,a0,1764 # ffffffffc0204930 <commands+0x830>
ffffffffc0201254:	a06ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201258:	00004697          	auipc	a3,0x4
ffffffffc020125c:	87868693          	addi	a3,a3,-1928 # ffffffffc0204ad0 <commands+0x9d0>
ffffffffc0201260:	00003617          	auipc	a2,0x3
ffffffffc0201264:	6b860613          	addi	a2,a2,1720 # ffffffffc0204918 <commands+0x818>
ffffffffc0201268:	0dc00593          	li	a1,220
ffffffffc020126c:	00003517          	auipc	a0,0x3
ffffffffc0201270:	6c450513          	addi	a0,a0,1732 # ffffffffc0204930 <commands+0x830>
ffffffffc0201274:	9e6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201278:	00003697          	auipc	a3,0x3
ffffffffc020127c:	6f068693          	addi	a3,a3,1776 # ffffffffc0204968 <commands+0x868>
ffffffffc0201280:	00003617          	auipc	a2,0x3
ffffffffc0201284:	69860613          	addi	a2,a2,1688 # ffffffffc0204918 <commands+0x818>
ffffffffc0201288:	0b900593          	li	a1,185
ffffffffc020128c:	00003517          	auipc	a0,0x3
ffffffffc0201290:	6a450513          	addi	a0,a0,1700 # ffffffffc0204930 <commands+0x830>
ffffffffc0201294:	9c6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201298:	00003697          	auipc	a3,0x3
ffffffffc020129c:	7f868693          	addi	a3,a3,2040 # ffffffffc0204a90 <commands+0x990>
ffffffffc02012a0:	00003617          	auipc	a2,0x3
ffffffffc02012a4:	67860613          	addi	a2,a2,1656 # ffffffffc0204918 <commands+0x818>
ffffffffc02012a8:	0d600593          	li	a1,214
ffffffffc02012ac:	00003517          	auipc	a0,0x3
ffffffffc02012b0:	68450513          	addi	a0,a0,1668 # ffffffffc0204930 <commands+0x830>
ffffffffc02012b4:	9a6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012b8:	00003697          	auipc	a3,0x3
ffffffffc02012bc:	6f068693          	addi	a3,a3,1776 # ffffffffc02049a8 <commands+0x8a8>
ffffffffc02012c0:	00003617          	auipc	a2,0x3
ffffffffc02012c4:	65860613          	addi	a2,a2,1624 # ffffffffc0204918 <commands+0x818>
ffffffffc02012c8:	0d400593          	li	a1,212
ffffffffc02012cc:	00003517          	auipc	a0,0x3
ffffffffc02012d0:	66450513          	addi	a0,a0,1636 # ffffffffc0204930 <commands+0x830>
ffffffffc02012d4:	986ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012d8:	00003697          	auipc	a3,0x3
ffffffffc02012dc:	6b068693          	addi	a3,a3,1712 # ffffffffc0204988 <commands+0x888>
ffffffffc02012e0:	00003617          	auipc	a2,0x3
ffffffffc02012e4:	63860613          	addi	a2,a2,1592 # ffffffffc0204918 <commands+0x818>
ffffffffc02012e8:	0d300593          	li	a1,211
ffffffffc02012ec:	00003517          	auipc	a0,0x3
ffffffffc02012f0:	64450513          	addi	a0,a0,1604 # ffffffffc0204930 <commands+0x830>
ffffffffc02012f4:	966ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02012f8:	00003697          	auipc	a3,0x3
ffffffffc02012fc:	6b068693          	addi	a3,a3,1712 # ffffffffc02049a8 <commands+0x8a8>
ffffffffc0201300:	00003617          	auipc	a2,0x3
ffffffffc0201304:	61860613          	addi	a2,a2,1560 # ffffffffc0204918 <commands+0x818>
ffffffffc0201308:	0bb00593          	li	a1,187
ffffffffc020130c:	00003517          	auipc	a0,0x3
ffffffffc0201310:	62450513          	addi	a0,a0,1572 # ffffffffc0204930 <commands+0x830>
ffffffffc0201314:	946ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(count == 0);
ffffffffc0201318:	00004697          	auipc	a3,0x4
ffffffffc020131c:	93868693          	addi	a3,a3,-1736 # ffffffffc0204c50 <commands+0xb50>
ffffffffc0201320:	00003617          	auipc	a2,0x3
ffffffffc0201324:	5f860613          	addi	a2,a2,1528 # ffffffffc0204918 <commands+0x818>
ffffffffc0201328:	12500593          	li	a1,293
ffffffffc020132c:	00003517          	auipc	a0,0x3
ffffffffc0201330:	60450513          	addi	a0,a0,1540 # ffffffffc0204930 <commands+0x830>
ffffffffc0201334:	926ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free == 0);
ffffffffc0201338:	00003697          	auipc	a3,0x3
ffffffffc020133c:	7b868693          	addi	a3,a3,1976 # ffffffffc0204af0 <commands+0x9f0>
ffffffffc0201340:	00003617          	auipc	a2,0x3
ffffffffc0201344:	5d860613          	addi	a2,a2,1496 # ffffffffc0204918 <commands+0x818>
ffffffffc0201348:	11a00593          	li	a1,282
ffffffffc020134c:	00003517          	auipc	a0,0x3
ffffffffc0201350:	5e450513          	addi	a0,a0,1508 # ffffffffc0204930 <commands+0x830>
ffffffffc0201354:	906ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201358:	00003697          	auipc	a3,0x3
ffffffffc020135c:	73868693          	addi	a3,a3,1848 # ffffffffc0204a90 <commands+0x990>
ffffffffc0201360:	00003617          	auipc	a2,0x3
ffffffffc0201364:	5b860613          	addi	a2,a2,1464 # ffffffffc0204918 <commands+0x818>
ffffffffc0201368:	11800593          	li	a1,280
ffffffffc020136c:	00003517          	auipc	a0,0x3
ffffffffc0201370:	5c450513          	addi	a0,a0,1476 # ffffffffc0204930 <commands+0x830>
ffffffffc0201374:	8e6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201378:	00003697          	auipc	a3,0x3
ffffffffc020137c:	6d868693          	addi	a3,a3,1752 # ffffffffc0204a50 <commands+0x950>
ffffffffc0201380:	00003617          	auipc	a2,0x3
ffffffffc0201384:	59860613          	addi	a2,a2,1432 # ffffffffc0204918 <commands+0x818>
ffffffffc0201388:	0c100593          	li	a1,193
ffffffffc020138c:	00003517          	auipc	a0,0x3
ffffffffc0201390:	5a450513          	addi	a0,a0,1444 # ffffffffc0204930 <commands+0x830>
ffffffffc0201394:	8c6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201398:	00004697          	auipc	a3,0x4
ffffffffc020139c:	87868693          	addi	a3,a3,-1928 # ffffffffc0204c10 <commands+0xb10>
ffffffffc02013a0:	00003617          	auipc	a2,0x3
ffffffffc02013a4:	57860613          	addi	a2,a2,1400 # ffffffffc0204918 <commands+0x818>
ffffffffc02013a8:	11200593          	li	a1,274
ffffffffc02013ac:	00003517          	auipc	a0,0x3
ffffffffc02013b0:	58450513          	addi	a0,a0,1412 # ffffffffc0204930 <commands+0x830>
ffffffffc02013b4:	8a6ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02013b8:	00004697          	auipc	a3,0x4
ffffffffc02013bc:	83868693          	addi	a3,a3,-1992 # ffffffffc0204bf0 <commands+0xaf0>
ffffffffc02013c0:	00003617          	auipc	a2,0x3
ffffffffc02013c4:	55860613          	addi	a2,a2,1368 # ffffffffc0204918 <commands+0x818>
ffffffffc02013c8:	11000593          	li	a1,272
ffffffffc02013cc:	00003517          	auipc	a0,0x3
ffffffffc02013d0:	56450513          	addi	a0,a0,1380 # ffffffffc0204930 <commands+0x830>
ffffffffc02013d4:	886ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02013d8:	00003697          	auipc	a3,0x3
ffffffffc02013dc:	7f068693          	addi	a3,a3,2032 # ffffffffc0204bc8 <commands+0xac8>
ffffffffc02013e0:	00003617          	auipc	a2,0x3
ffffffffc02013e4:	53860613          	addi	a2,a2,1336 # ffffffffc0204918 <commands+0x818>
ffffffffc02013e8:	10e00593          	li	a1,270
ffffffffc02013ec:	00003517          	auipc	a0,0x3
ffffffffc02013f0:	54450513          	addi	a0,a0,1348 # ffffffffc0204930 <commands+0x830>
ffffffffc02013f4:	866ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02013f8:	00003697          	auipc	a3,0x3
ffffffffc02013fc:	7a868693          	addi	a3,a3,1960 # ffffffffc0204ba0 <commands+0xaa0>
ffffffffc0201400:	00003617          	auipc	a2,0x3
ffffffffc0201404:	51860613          	addi	a2,a2,1304 # ffffffffc0204918 <commands+0x818>
ffffffffc0201408:	10d00593          	li	a1,269
ffffffffc020140c:	00003517          	auipc	a0,0x3
ffffffffc0201410:	52450513          	addi	a0,a0,1316 # ffffffffc0204930 <commands+0x830>
ffffffffc0201414:	846ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201418:	00003697          	auipc	a3,0x3
ffffffffc020141c:	77868693          	addi	a3,a3,1912 # ffffffffc0204b90 <commands+0xa90>
ffffffffc0201420:	00003617          	auipc	a2,0x3
ffffffffc0201424:	4f860613          	addi	a2,a2,1272 # ffffffffc0204918 <commands+0x818>
ffffffffc0201428:	10800593          	li	a1,264
ffffffffc020142c:	00003517          	auipc	a0,0x3
ffffffffc0201430:	50450513          	addi	a0,a0,1284 # ffffffffc0204930 <commands+0x830>
ffffffffc0201434:	826ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201438:	00003697          	auipc	a3,0x3
ffffffffc020143c:	65868693          	addi	a3,a3,1624 # ffffffffc0204a90 <commands+0x990>
ffffffffc0201440:	00003617          	auipc	a2,0x3
ffffffffc0201444:	4d860613          	addi	a2,a2,1240 # ffffffffc0204918 <commands+0x818>
ffffffffc0201448:	10700593          	li	a1,263
ffffffffc020144c:	00003517          	auipc	a0,0x3
ffffffffc0201450:	4e450513          	addi	a0,a0,1252 # ffffffffc0204930 <commands+0x830>
ffffffffc0201454:	806ff0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201458:	00003697          	auipc	a3,0x3
ffffffffc020145c:	71868693          	addi	a3,a3,1816 # ffffffffc0204b70 <commands+0xa70>
ffffffffc0201460:	00003617          	auipc	a2,0x3
ffffffffc0201464:	4b860613          	addi	a2,a2,1208 # ffffffffc0204918 <commands+0x818>
ffffffffc0201468:	10600593          	li	a1,262
ffffffffc020146c:	00003517          	auipc	a0,0x3
ffffffffc0201470:	4c450513          	addi	a0,a0,1220 # ffffffffc0204930 <commands+0x830>
ffffffffc0201474:	fe7fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201478:	00003697          	auipc	a3,0x3
ffffffffc020147c:	6c868693          	addi	a3,a3,1736 # ffffffffc0204b40 <commands+0xa40>
ffffffffc0201480:	00003617          	auipc	a2,0x3
ffffffffc0201484:	49860613          	addi	a2,a2,1176 # ffffffffc0204918 <commands+0x818>
ffffffffc0201488:	10500593          	li	a1,261
ffffffffc020148c:	00003517          	auipc	a0,0x3
ffffffffc0201490:	4a450513          	addi	a0,a0,1188 # ffffffffc0204930 <commands+0x830>
ffffffffc0201494:	fc7fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201498:	00003697          	auipc	a3,0x3
ffffffffc020149c:	69068693          	addi	a3,a3,1680 # ffffffffc0204b28 <commands+0xa28>
ffffffffc02014a0:	00003617          	auipc	a2,0x3
ffffffffc02014a4:	47860613          	addi	a2,a2,1144 # ffffffffc0204918 <commands+0x818>
ffffffffc02014a8:	10400593          	li	a1,260
ffffffffc02014ac:	00003517          	auipc	a0,0x3
ffffffffc02014b0:	48450513          	addi	a0,a0,1156 # ffffffffc0204930 <commands+0x830>
ffffffffc02014b4:	fa7fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(alloc_page() == NULL);
ffffffffc02014b8:	00003697          	auipc	a3,0x3
ffffffffc02014bc:	5d868693          	addi	a3,a3,1496 # ffffffffc0204a90 <commands+0x990>
ffffffffc02014c0:	00003617          	auipc	a2,0x3
ffffffffc02014c4:	45860613          	addi	a2,a2,1112 # ffffffffc0204918 <commands+0x818>
ffffffffc02014c8:	0fe00593          	li	a1,254
ffffffffc02014cc:	00003517          	auipc	a0,0x3
ffffffffc02014d0:	46450513          	addi	a0,a0,1124 # ffffffffc0204930 <commands+0x830>
ffffffffc02014d4:	f87fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(!PageProperty(p0));
ffffffffc02014d8:	00003697          	auipc	a3,0x3
ffffffffc02014dc:	63868693          	addi	a3,a3,1592 # ffffffffc0204b10 <commands+0xa10>
ffffffffc02014e0:	00003617          	auipc	a2,0x3
ffffffffc02014e4:	43860613          	addi	a2,a2,1080 # ffffffffc0204918 <commands+0x818>
ffffffffc02014e8:	0f900593          	li	a1,249
ffffffffc02014ec:	00003517          	auipc	a0,0x3
ffffffffc02014f0:	44450513          	addi	a0,a0,1092 # ffffffffc0204930 <commands+0x830>
ffffffffc02014f4:	f67fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02014f8:	00003697          	auipc	a3,0x3
ffffffffc02014fc:	73868693          	addi	a3,a3,1848 # ffffffffc0204c30 <commands+0xb30>
ffffffffc0201500:	00003617          	auipc	a2,0x3
ffffffffc0201504:	41860613          	addi	a2,a2,1048 # ffffffffc0204918 <commands+0x818>
ffffffffc0201508:	11700593          	li	a1,279
ffffffffc020150c:	00003517          	auipc	a0,0x3
ffffffffc0201510:	42450513          	addi	a0,a0,1060 # ffffffffc0204930 <commands+0x830>
ffffffffc0201514:	f47fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == 0);
ffffffffc0201518:	00003697          	auipc	a3,0x3
ffffffffc020151c:	74868693          	addi	a3,a3,1864 # ffffffffc0204c60 <commands+0xb60>
ffffffffc0201520:	00003617          	auipc	a2,0x3
ffffffffc0201524:	3f860613          	addi	a2,a2,1016 # ffffffffc0204918 <commands+0x818>
ffffffffc0201528:	12600593          	li	a1,294
ffffffffc020152c:	00003517          	auipc	a0,0x3
ffffffffc0201530:	40450513          	addi	a0,a0,1028 # ffffffffc0204930 <commands+0x830>
ffffffffc0201534:	f27fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(total == nr_free_pages());
ffffffffc0201538:	00003697          	auipc	a3,0x3
ffffffffc020153c:	41068693          	addi	a3,a3,1040 # ffffffffc0204948 <commands+0x848>
ffffffffc0201540:	00003617          	auipc	a2,0x3
ffffffffc0201544:	3d860613          	addi	a2,a2,984 # ffffffffc0204918 <commands+0x818>
ffffffffc0201548:	0f300593          	li	a1,243
ffffffffc020154c:	00003517          	auipc	a0,0x3
ffffffffc0201550:	3e450513          	addi	a0,a0,996 # ffffffffc0204930 <commands+0x830>
ffffffffc0201554:	f07fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201558:	00003697          	auipc	a3,0x3
ffffffffc020155c:	43068693          	addi	a3,a3,1072 # ffffffffc0204988 <commands+0x888>
ffffffffc0201560:	00003617          	auipc	a2,0x3
ffffffffc0201564:	3b860613          	addi	a2,a2,952 # ffffffffc0204918 <commands+0x818>
ffffffffc0201568:	0ba00593          	li	a1,186
ffffffffc020156c:	00003517          	auipc	a0,0x3
ffffffffc0201570:	3c450513          	addi	a0,a0,964 # ffffffffc0204930 <commands+0x830>
...
ffffffffc02016a8:	5d468693          	addi	a3,a3,1492 # ffffffffc0204c78 <commands+0xb78>
ffffffffc02016ac:	00003617          	auipc	a2,0x3
ffffffffc02016b0:	26c60613          	addi	a2,a2,620 # ffffffffc0204918 <commands+0x818>
ffffffffc02016b4:	08300593          	li	a1,131
ffffffffc02016b8:	00003517          	auipc	a0,0x3
ffffffffc02016bc:	27850513          	addi	a0,a0,632 # ffffffffc0204930 <commands+0x830>
ffffffffc02016c0:	d9bfe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc02016c4:	00003697          	auipc	a3,0x3
ffffffffc02016c8:	5ac68693          	addi	a3,a3,1452 # ffffffffc0204c70 <commands+0xb70>
ffffffffc02016cc:	00003617          	auipc	a2,0x3
ffffffffc02016d0:	24c60613          	addi	a2,a2,588 # ffffffffc0204918 <commands+0x818>
ffffffffc02016d4:	08000593          	li	a1,128
ffffffffc02016d8:	00003517          	auipc	a0,0x3
ffffffffc02016dc:	25850513          	addi	a0,a0,600 # ffffffffc0204930 <commands+0x830>
...
ffffffffc020177a:	4fa68693          	addi	a3,a3,1274 # ffffffffc0204c70 <commands+0xb70>
ffffffffc020177e:	00003617          	auipc	a2,0x3
ffffffffc0201782:	19a60613          	addi	a2,a2,410 # ffffffffc0204918 <commands+0x818>
ffffffffc0201786:	06200593          	li	a1,98
ffffffffc020178a:	00003517          	auipc	a0,0x3
ffffffffc020178e:	1a650513          	addi	a0,a0,422 # ffffffffc0204930 <commands+0x830>
default_alloc_pages(size_t n) {
...
ffffffffc020184c:	45868693          	addi	a3,a3,1112 # ffffffffc0204ca0 <commands+0xba0>
ffffffffc0201850:	00003617          	auipc	a2,0x3
ffffffffc0201854:	0c860613          	addi	a2,a2,200 # ffffffffc0204918 <commands+0x818>
ffffffffc0201858:	04900593          	li	a1,73
ffffffffc020185c:	00003517          	auipc	a0,0x3
ffffffffc0201860:	0d450513          	addi	a0,a0,212 # ffffffffc0204930 <commands+0x830>
ffffffffc0201864:	bf7fe0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(n > 0);
ffffffffc0201868:	00003697          	auipc	a3,0x3
ffffffffc020186c:	40868693          	addi	a3,a3,1032 # ffffffffc0204c70 <commands+0xb70>
ffffffffc0201870:	00003617          	auipc	a2,0x3
ffffffffc0201874:	0a860613          	addi	a2,a2,168 # ffffffffc0204918 <commands+0x818>
ffffffffc0201878:	04600593          	li	a1,70
ffffffffc020187c:	00003517          	auipc	a0,0x3
ffffffffc0201880:	0b450513          	addi	a0,a0,180 # ffffffffc0204930 <commands+0x830>
...
ffffffffc020195c:	0886b683          	ld	a3,136(a3) # ffffffffc02059e0 <nbase>
...
ffffffffc020198c:	37860613          	addi	a2,a2,888 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0201990:	07100593          	li	a1,113
ffffffffc0201994:	00003517          	auipc	a0,0x3
ffffffffc0201998:	39450513          	addi	a0,a0,916 # ffffffffc0204d28 <default_pmm_manager+0x60>
...
ffffffffc0201a7a:	2c268693          	addi	a3,a3,706 # ffffffffc0204d38 <default_pmm_manager+0x70>
ffffffffc0201a7e:	00003617          	auipc	a2,0x3
ffffffffc0201a82:	e9a60613          	addi	a2,a2,-358 # ffffffffc0204918 <commands+0x818>
ffffffffc0201a86:	06300593          	li	a1,99
ffffffffc0201a8a:	00003517          	auipc	a0,0x3
ffffffffc0201a8e:	2ce50513          	addi	a0,a0,718 # ffffffffc0204d58 <default_pmm_manager+0x90>
...
ffffffffc0201a9c:	2d850513          	addi	a0,a0,728 # ffffffffc0204d70 <default_pmm_manager+0xa8>
{
...
ffffffffc0201aac:	2e050513          	addi	a0,a0,736 # ffffffffc0204d88 <default_pmm_manager+0xc0>
}
...
ffffffffc0201bd0:	e1453503          	ld	a0,-492(a0) # ffffffffc02059e0 <nbase>
...
ffffffffc0201c2e:	1a660613          	addi	a2,a2,422 # ffffffffc0204dd0 <default_pmm_manager+0x108>
ffffffffc0201c32:	06900593          	li	a1,105
ffffffffc0201c36:	00003517          	auipc	a0,0x3
ffffffffc0201c3a:	0f250513          	addi	a0,a0,242 # ffffffffc0204d28 <default_pmm_manager+0x60>
...
ffffffffc0201c48:	16460613          	addi	a2,a2,356 # ffffffffc0204da8 <default_pmm_manager+0xe0>
ffffffffc0201c4c:	07700593          	li	a1,119
ffffffffc0201c50:	00003517          	auipc	a0,0x3
ffffffffc0201c54:	0d850513          	addi	a0,a0,216 # ffffffffc0204d28 <default_pmm_manager+0x60>
...
ffffffffc0201c62:	17260613          	addi	a2,a2,370 # ffffffffc0204dd0 <default_pmm_manager+0x108>
ffffffffc0201c66:	06900593          	li	a1,105
ffffffffc0201c6a:	00003517          	auipc	a0,0x3
ffffffffc0201c6e:	0be50513          	addi	a0,a0,190 # ffffffffc0204d28 <default_pmm_manager+0x60>
pa2page(uintptr_t pa)
...
ffffffffc0201c7e:	17660613          	addi	a2,a2,374 # ffffffffc0204df0 <default_pmm_manager+0x128>
ffffffffc0201c82:	07f00593          	li	a1,127
ffffffffc0201c86:	00003517          	auipc	a0,0x3
ffffffffc0201c8a:	0a250513          	addi	a0,a0,162 # ffffffffc0204d28 <default_pmm_manager+0x60>
pte2page(pte_t pte)
...
ffffffffc0201de4:	064020ef          	jal	ra,ffffffffc0203e48 <memset>
    return page - pages + nbase;
...
ffffffffc0201e86:	7c3010ef          	jal	ra,ffffffffc0203e48 <memset>
    return page - pages + nbase;
...
ffffffffc0201f14:	df060613          	addi	a2,a2,-528 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0201f18:	0fb00593          	li	a1,251
ffffffffc0201f1c:	00003517          	auipc	a0,0x3
ffffffffc0201f20:	efc50513          	addi	a0,a0,-260 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0201f24:	d36fe0ef          	jal	ra,ffffffffc020045a <__panic>
    pde_t *pdep0 = &((pte_t *)KADDR(PDE_ADDR(*pdep1)))[PDX0(la)];
ffffffffc0201f28:	00003617          	auipc	a2,0x3
ffffffffc0201f2c:	dd860613          	addi	a2,a2,-552 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0201f30:	0ee00593          	li	a1,238
ffffffffc0201f34:	00003517          	auipc	a0,0x3
ffffffffc0201f38:	ee450513          	addi	a0,a0,-284 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc0201f46:	dbe60613          	addi	a2,a2,-578 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0201f4a:	0eb00593          	li	a1,235
ffffffffc0201f4e:	00003517          	auipc	a0,0x3
ffffffffc0201f52:	eca50513          	addi	a0,a0,-310 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc0201f60:	da460613          	addi	a2,a2,-604 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0201f64:	0f800593          	li	a1,248
ffffffffc0201f68:	00003517          	auipc	a0,0x3
ffffffffc0201f6c:	eb050513          	addi	a0,a0,-336 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc020215e:	b6e78793          	addi	a5,a5,-1170 # ffffffffc0204cc8 <default_pmm_manager>
...
ffffffffc020216c:	cc050513          	addi	a0,a0,-832 # ffffffffc0204e28 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc02021c0:	ca450513          	addi	a0,a0,-860 # ffffffffc0204e60 <default_pmm_manager+0x198>
...
ffffffffc02021d8:	ca450513          	addi	a0,a0,-860 # ffffffffc0204e78 <default_pmm_manager+0x1b0>
...
ffffffffc0202260:	c4450513          	addi	a0,a0,-956 # ffffffffc0204ea0 <default_pmm_manager+0x1d8>
...
ffffffffc020227c:	c4050513          	addi	a0,a0,-960 # ffffffffc0204eb8 <default_pmm_manager+0x1f0>
...
ffffffffc0202532:	cb250513          	addi	a0,a0,-846 # ffffffffc02051e0 <default_pmm_manager+0x518>
...
ffffffffc02025f6:	d3658593          	addi	a1,a1,-714 # ffffffffc0205328 <default_pmm_manager+0x660>
ffffffffc02025fa:	10000513          	li	a0,256
ffffffffc02025fe:	7de010ef          	jal	ra,ffffffffc0203ddc <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202602:	10040593          	addi	a1,s0,256
ffffffffc0202606:	10000513          	li	a0,256
ffffffffc020260a:	7e4010ef          	jal	ra,ffffffffc0203dee <strcmp>
...
ffffffffc020263c:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202640:	766010ef          	jal	ra,ffffffffc0203da6 <strlen>
...
ffffffffc0202704:	ca050513          	addi	a0,a0,-864 # ffffffffc02053a0 <default_pmm_manager+0x6d8>
...
ffffffffc020286c:	49860613          	addi	a2,a2,1176 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0202870:	1a400593          	li	a1,420
ffffffffc0202874:	00002517          	auipc	a0,0x2
ffffffffc0202878:	5a450513          	addi	a0,a0,1444 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc020287c:	bdffd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202880:	00003697          	auipc	a3,0x3
ffffffffc0202884:	9c068693          	addi	a3,a3,-1600 # ffffffffc0205240 <default_pmm_manager+0x578>
ffffffffc0202888:	00002617          	auipc	a2,0x2
ffffffffc020288c:	09060613          	addi	a2,a2,144 # ffffffffc0204918 <commands+0x818>
ffffffffc0202890:	1a500593          	li	a1,421
ffffffffc0202894:	00002517          	auipc	a0,0x2
ffffffffc0202898:	58450513          	addi	a0,a0,1412 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc020289c:	bbffd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert((ptep = get_pte(boot_pgdir_va, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02028a0:	00003697          	auipc	a3,0x3
ffffffffc02028a4:	96068693          	addi	a3,a3,-1696 # ffffffffc0205200 <default_pmm_manager+0x538>
ffffffffc02028a8:	00002617          	auipc	a2,0x2
ffffffffc02028ac:	07060613          	addi	a2,a2,112 # ffffffffc0204918 <commands+0x818>
ffffffffc02028b0:	1a400593          	li	a1,420
ffffffffc02028b4:	00002517          	auipc	a0,0x2
ffffffffc02028b8:	56450513          	addi	a0,a0,1380 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc02028cc:	73068693          	addi	a3,a3,1840 # ffffffffc0204ff8 <default_pmm_manager+0x330>
ffffffffc02028d0:	00002617          	auipc	a2,0x2
ffffffffc02028d4:	04860613          	addi	a2,a2,72 # ffffffffc0204918 <commands+0x818>
ffffffffc02028d8:	17400593          	li	a1,372
ffffffffc02028dc:	00002517          	auipc	a0,0x2
ffffffffc02028e0:	53c50513          	addi	a0,a0,1340 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc02028e4:	b77fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(get_page(boot_pgdir_va, 0x0, NULL) == NULL);
ffffffffc02028e8:	00002697          	auipc	a3,0x2
ffffffffc02028ec:	65068693          	addi	a3,a3,1616 # ffffffffc0204f38 <default_pmm_manager+0x270>
ffffffffc02028f0:	00002617          	auipc	a2,0x2
ffffffffc02028f4:	02860613          	addi	a2,a2,40 # ffffffffc0204918 <commands+0x818>
ffffffffc02028f8:	16700593          	li	a1,359
ffffffffc02028fc:	00002517          	auipc	a0,0x2
ffffffffc0202900:	51c50513          	addi	a0,a0,1308 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202904:	b57fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va != NULL && (uint32_t)PGOFF(boot_pgdir_va) == 0);
ffffffffc0202908:	00002697          	auipc	a3,0x2
ffffffffc020290c:	5f068693          	addi	a3,a3,1520 # ffffffffc0204ef8 <default_pmm_manager+0x230>
ffffffffc0202910:	00002617          	auipc	a2,0x2
ffffffffc0202914:	00860613          	addi	a2,a2,8 # ffffffffc0204918 <commands+0x818>
ffffffffc0202918:	16600593          	li	a1,358
ffffffffc020291c:	00002517          	auipc	a0,0x2
ffffffffc0202920:	4fc50513          	addi	a0,a0,1276 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202924:	b37fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0202928:	00002697          	auipc	a3,0x2
ffffffffc020292c:	5b068693          	addi	a3,a3,1456 # ffffffffc0204ed8 <default_pmm_manager+0x210>
ffffffffc0202930:	00002617          	auipc	a2,0x2
ffffffffc0202934:	fe860613          	addi	a2,a2,-24 # ffffffffc0204918 <commands+0x818>
ffffffffc0202938:	16500593          	li	a1,357
ffffffffc020293c:	00002517          	auipc	a0,0x2
ffffffffc0202940:	4dc50513          	addi	a0,a0,1244 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202944:	b17fd0ef          	jal	ra,ffffffffc020045a <__panic>
    return KADDR(page2pa(page));
ffffffffc0202948:	00002617          	auipc	a2,0x2
ffffffffc020294c:	3b860613          	addi	a2,a2,952 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0202950:	07100593          	li	a1,113
ffffffffc0202954:	00002517          	auipc	a0,0x2
ffffffffc0202958:	3d450513          	addi	a0,a0,980 # ffffffffc0204d28 <default_pmm_manager+0x60>
ffffffffc020295c:	afffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(pde2page(boot_pgdir_va[0])) == 1);
ffffffffc0202960:	00003697          	auipc	a3,0x3
ffffffffc0202964:	82868693          	addi	a3,a3,-2008 # ffffffffc0205188 <default_pmm_manager+0x4c0>
ffffffffc0202968:	00002617          	auipc	a2,0x2
ffffffffc020296c:	fb060613          	addi	a2,a2,-80 # ffffffffc0204918 <commands+0x818>
ffffffffc0202970:	18d00593          	li	a1,397
ffffffffc0202974:	00002517          	auipc	a0,0x2
ffffffffc0202978:	4a450513          	addi	a0,a0,1188 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc020297c:	adffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202980:	00002697          	auipc	a3,0x2
ffffffffc0202984:	7c068693          	addi	a3,a3,1984 # ffffffffc0205140 <default_pmm_manager+0x478>
ffffffffc0202988:	00002617          	auipc	a2,0x2
ffffffffc020298c:	f9060613          	addi	a2,a2,-112 # ffffffffc0204918 <commands+0x818>
ffffffffc0202990:	18b00593          	li	a1,395
ffffffffc0202994:	00002517          	auipc	a0,0x2
ffffffffc0202998:	48450513          	addi	a0,a0,1156 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc020299c:	abffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02029a0:	00002697          	auipc	a3,0x2
ffffffffc02029a4:	7d068693          	addi	a3,a3,2000 # ffffffffc0205170 <default_pmm_manager+0x4a8>
ffffffffc02029a8:	00002617          	auipc	a2,0x2
ffffffffc02029ac:	f7060613          	addi	a2,a2,-144 # ffffffffc0204918 <commands+0x818>
ffffffffc02029b0:	18a00593          	li	a1,394
ffffffffc02029b4:	00002517          	auipc	a0,0x2
ffffffffc02029b8:	46450513          	addi	a0,a0,1124 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc02029bc:	a9ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] == 0);
ffffffffc02029c0:	00003697          	auipc	a3,0x3
ffffffffc02029c4:	89868693          	addi	a3,a3,-1896 # ffffffffc0205258 <default_pmm_manager+0x590>
ffffffffc02029c8:	00002617          	auipc	a2,0x2
ffffffffc02029cc:	f5060613          	addi	a2,a2,-176 # ffffffffc0204918 <commands+0x818>
ffffffffc02029d0:	1a800593          	li	a1,424
ffffffffc02029d4:	00002517          	auipc	a0,0x2
ffffffffc02029d8:	44450513          	addi	a0,a0,1092 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc02029dc:	a7ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc02029e0:	00002697          	auipc	a3,0x2
ffffffffc02029e4:	7d868693          	addi	a3,a3,2008 # ffffffffc02051b8 <default_pmm_manager+0x4f0>
ffffffffc02029e8:	00002617          	auipc	a2,0x2
ffffffffc02029ec:	f3060613          	addi	a2,a2,-208 # ffffffffc0204918 <commands+0x818>
ffffffffc02029f0:	19500593          	li	a1,405
ffffffffc02029f4:	00002517          	auipc	a0,0x2
ffffffffc02029f8:	42450513          	addi	a0,a0,1060 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc02029fc:	a5ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202a00:	00003697          	auipc	a3,0x3
ffffffffc0202a04:	8b068693          	addi	a3,a3,-1872 # ffffffffc02052b0 <default_pmm_manager+0x5e8>
ffffffffc0202a08:	00002617          	auipc	a2,0x2
ffffffffc0202a0c:	f1060613          	addi	a2,a2,-240 # ffffffffc0204918 <commands+0x818>
ffffffffc0202a10:	1ad00593          	li	a1,429
ffffffffc0202a14:	00002517          	auipc	a0,0x2
ffffffffc0202a18:	40450513          	addi	a0,a0,1028 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202a1c:	a3ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202a20:	00003697          	auipc	a3,0x3
ffffffffc0202a24:	85068693          	addi	a3,a3,-1968 # ffffffffc0205270 <default_pmm_manager+0x5a8>
ffffffffc0202a28:	00002617          	auipc	a2,0x2
ffffffffc0202a2c:	ef060613          	addi	a2,a2,-272 # ffffffffc0204918 <commands+0x818>
ffffffffc0202a30:	1ac00593          	li	a1,428
ffffffffc0202a34:	00002517          	auipc	a0,0x2
ffffffffc0202a38:	3e450513          	addi	a0,a0,996 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202a3c:	a1ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202a40:	00002697          	auipc	a3,0x2
ffffffffc0202a44:	70068693          	addi	a3,a3,1792 # ffffffffc0205140 <default_pmm_manager+0x478>
ffffffffc0202a48:	00002617          	auipc	a2,0x2
ffffffffc0202a4c:	ed060613          	addi	a2,a2,-304 # ffffffffc0204918 <commands+0x818>
ffffffffc0202a50:	18700593          	li	a1,391
ffffffffc0202a54:	00002517          	auipc	a0,0x2
ffffffffc0202a58:	3c450513          	addi	a0,a0,964 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202a5c:	9fffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202a60:	00002697          	auipc	a3,0x2
ffffffffc0202a64:	58068693          	addi	a3,a3,1408 # ffffffffc0204fe0 <default_pmm_manager+0x318>
ffffffffc0202a68:	00002617          	auipc	a2,0x2
ffffffffc0202a6c:	eb060613          	addi	a2,a2,-336 # ffffffffc0204918 <commands+0x818>
ffffffffc0202a70:	18600593          	li	a1,390
ffffffffc0202a74:	00002517          	auipc	a0,0x2
ffffffffc0202a78:	3a450513          	addi	a0,a0,932 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202a7c:	9dffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202a80:	00002697          	auipc	a3,0x2
ffffffffc0202a84:	6d868693          	addi	a3,a3,1752 # ffffffffc0205158 <default_pmm_manager+0x490>
ffffffffc0202a88:	00002617          	auipc	a2,0x2
ffffffffc0202a8c:	e9060613          	addi	a2,a2,-368 # ffffffffc0204918 <commands+0x818>
ffffffffc0202a90:	18300593          	li	a1,387
ffffffffc0202a94:	00002517          	auipc	a0,0x2
ffffffffc0202a98:	38450513          	addi	a0,a0,900 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202a9c:	9bffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202aa0:	00002697          	auipc	a3,0x2
ffffffffc0202aa4:	52868693          	addi	a3,a3,1320 # ffffffffc0204fc8 <default_pmm_manager+0x300>
ffffffffc0202aa8:	00002617          	auipc	a2,0x2
ffffffffc0202aac:	e7060613          	addi	a2,a2,-400 # ffffffffc0204918 <commands+0x818>
ffffffffc0202ab0:	18200593          	li	a1,386
ffffffffc0202ab4:	00002517          	auipc	a0,0x2
ffffffffc0202ab8:	36450513          	addi	a0,a0,868 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202abc:	99ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202ac0:	00002697          	auipc	a3,0x2
ffffffffc0202ac4:	5a868693          	addi	a3,a3,1448 # ffffffffc0205068 <default_pmm_manager+0x3a0>
ffffffffc0202ac8:	00002617          	auipc	a2,0x2
ffffffffc0202acc:	e5060613          	addi	a2,a2,-432 # ffffffffc0204918 <commands+0x818>
ffffffffc0202ad0:	18100593          	li	a1,385
ffffffffc0202ad4:	00002517          	auipc	a0,0x2
ffffffffc0202ad8:	34450513          	addi	a0,a0,836 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202adc:	97ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202ae0:	00002697          	auipc	a3,0x2
ffffffffc0202ae4:	66068693          	addi	a3,a3,1632 # ffffffffc0205140 <default_pmm_manager+0x478>
ffffffffc0202ae8:	00002617          	auipc	a2,0x2
ffffffffc0202aec:	e3060613          	addi	a2,a2,-464 # ffffffffc0204918 <commands+0x818>
ffffffffc0202af0:	18000593          	li	a1,384
ffffffffc0202af4:	00002517          	auipc	a0,0x2
ffffffffc0202af8:	32450513          	addi	a0,a0,804 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202afc:	95ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202b00:	00002697          	auipc	a3,0x2
ffffffffc0202b04:	62868693          	addi	a3,a3,1576 # ffffffffc0205128 <default_pmm_manager+0x460>
ffffffffc0202b08:	00002617          	auipc	a2,0x2
ffffffffc0202b0c:	e1060613          	addi	a2,a2,-496 # ffffffffc0204918 <commands+0x818>
ffffffffc0202b10:	17f00593          	li	a1,383
ffffffffc0202b14:	00002517          	auipc	a0,0x2
ffffffffc0202b18:	30450513          	addi	a0,a0,772 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202b1c:	93ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, PGSIZE, 0) == 0);
ffffffffc0202b20:	00002697          	auipc	a3,0x2
ffffffffc0202b24:	5d868693          	addi	a3,a3,1496 # ffffffffc02050f8 <default_pmm_manager+0x430>
ffffffffc0202b28:	00002617          	auipc	a2,0x2
ffffffffc0202b2c:	df060613          	addi	a2,a2,-528 # ffffffffc0204918 <commands+0x818>
ffffffffc0202b30:	17e00593          	li	a1,382
ffffffffc0202b34:	00002517          	auipc	a0,0x2
ffffffffc0202b38:	2e450513          	addi	a0,a0,740 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202b3c:	91ffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202b40:	00002697          	auipc	a3,0x2
ffffffffc0202b44:	5a068693          	addi	a3,a3,1440 # ffffffffc02050e0 <default_pmm_manager+0x418>
ffffffffc0202b48:	00002617          	auipc	a2,0x2
ffffffffc0202b4c:	dd060613          	addi	a2,a2,-560 # ffffffffc0204918 <commands+0x818>
ffffffffc0202b50:	17c00593          	li	a1,380
ffffffffc0202b54:	00002517          	auipc	a0,0x2
ffffffffc0202b58:	2c450513          	addi	a0,a0,708 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202b5c:	8fffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(boot_pgdir_va[0] & PTE_U);
ffffffffc0202b60:	00002697          	auipc	a3,0x2
ffffffffc0202b64:	56068693          	addi	a3,a3,1376 # ffffffffc02050c0 <default_pmm_manager+0x3f8>
ffffffffc0202b68:	00002617          	auipc	a2,0x2
ffffffffc0202b6c:	db060613          	addi	a2,a2,-592 # ffffffffc0204918 <commands+0x818>
ffffffffc0202b70:	17b00593          	li	a1,379
ffffffffc0202b74:	00002517          	auipc	a0,0x2
ffffffffc0202b78:	2a450513          	addi	a0,a0,676 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202b7c:	8dffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202b80:	00002697          	auipc	a3,0x2
ffffffffc0202b84:	53068693          	addi	a3,a3,1328 # ffffffffc02050b0 <default_pmm_manager+0x3e8>
ffffffffc0202b88:	00002617          	auipc	a2,0x2
ffffffffc0202b8c:	d9060613          	addi	a2,a2,-624 # ffffffffc0204918 <commands+0x818>
ffffffffc0202b90:	17a00593          	li	a1,378
ffffffffc0202b94:	00002517          	auipc	a0,0x2
ffffffffc0202b98:	28450513          	addi	a0,a0,644 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202b9c:	8bffd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202ba0:	00002697          	auipc	a3,0x2
ffffffffc0202ba4:	50068693          	addi	a3,a3,1280 # ffffffffc02050a0 <default_pmm_manager+0x3d8>
ffffffffc0202ba8:	00002617          	auipc	a2,0x2
ffffffffc0202bac:	d7060613          	addi	a2,a2,-656 # ffffffffc0204918 <commands+0x818>
ffffffffc0202bb0:	17900593          	li	a1,377
ffffffffc0202bb4:	00002517          	auipc	a0,0x2
ffffffffc0202bb8:	26450513          	addi	a0,a0,612 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202bbc:	89ffd0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("DTB memory info not available");
ffffffffc0202bc0:	00002617          	auipc	a2,0x2
ffffffffc0202bc4:	28060613          	addi	a2,a2,640 # ffffffffc0204e40 <default_pmm_manager+0x178>
ffffffffc0202bc8:	06400593          	li	a1,100
ffffffffc0202bcc:	00002517          	auipc	a0,0x2
ffffffffc0202bd0:	24c50513          	addi	a0,a0,588 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202bd4:	887fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(nr_free_store == nr_free_pages());
ffffffffc0202bd8:	00002697          	auipc	a3,0x2
ffffffffc0202bdc:	5e068693          	addi	a3,a3,1504 # ffffffffc02051b8 <default_pmm_manager+0x4f0>
ffffffffc0202be0:	00002617          	auipc	a2,0x2
ffffffffc0202be4:	d3860613          	addi	a2,a2,-712 # ffffffffc0204918 <commands+0x818>
ffffffffc0202be8:	1bf00593          	li	a1,447
ffffffffc0202bec:	00002517          	auipc	a0,0x2
ffffffffc0202bf0:	22c50513          	addi	a0,a0,556 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202bf4:	867fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, PGSIZE, 0)) != NULL);
ffffffffc0202bf8:	00002697          	auipc	a3,0x2
ffffffffc0202bfc:	47068693          	addi	a3,a3,1136 # ffffffffc0205068 <default_pmm_manager+0x3a0>
ffffffffc0202c00:	00002617          	auipc	a2,0x2
ffffffffc0202c04:	d1860613          	addi	a2,a2,-744 # ffffffffc0204918 <commands+0x818>
ffffffffc0202c08:	17800593          	li	a1,376
ffffffffc0202c0c:	00002517          	auipc	a0,0x2
ffffffffc0202c10:	20c50513          	addi	a0,a0,524 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202c14:	847fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202c18:	00002697          	auipc	a3,0x2
ffffffffc0202c1c:	41068693          	addi	a3,a3,1040 # ffffffffc0205028 <default_pmm_manager+0x360>
ffffffffc0202c20:	00002617          	auipc	a2,0x2
ffffffffc0202c24:	cf860613          	addi	a2,a2,-776 # ffffffffc0204918 <commands+0x818>
ffffffffc0202c28:	17700593          	li	a1,375
ffffffffc0202c2c:	00002517          	auipc	a0,0x2
ffffffffc0202c30:	1ec50513          	addi	a0,a0,492 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc0202c3e:	0c660613          	addi	a2,a2,198 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0202c42:	17300593          	li	a1,371
ffffffffc0202c46:	00002517          	auipc	a0,0x2
ffffffffc0202c4a:	1d250513          	addi	a0,a0,466 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202c4e:	80dfd0ef          	jal	ra,ffffffffc020045a <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir_va[0]));
ffffffffc0202c52:	00002617          	auipc	a2,0x2
ffffffffc0202c56:	0ae60613          	addi	a2,a2,174 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc0202c5a:	17200593          	li	a1,370
ffffffffc0202c5e:	00002517          	auipc	a0,0x2
ffffffffc0202c62:	1ba50513          	addi	a0,a0,442 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202c66:	ff4fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202c6a:	00002697          	auipc	a3,0x2
ffffffffc0202c6e:	37668693          	addi	a3,a3,886 # ffffffffc0204fe0 <default_pmm_manager+0x318>
ffffffffc0202c72:	00002617          	auipc	a2,0x2
ffffffffc0202c76:	ca660613          	addi	a2,a2,-858 # ffffffffc0204918 <commands+0x818>
ffffffffc0202c7a:	17000593          	li	a1,368
ffffffffc0202c7e:	00002517          	auipc	a0,0x2
ffffffffc0202c82:	19a50513          	addi	a0,a0,410 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202c86:	fd4fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202c8a:	00002697          	auipc	a3,0x2
ffffffffc0202c8e:	33e68693          	addi	a3,a3,830 # ffffffffc0204fc8 <default_pmm_manager+0x300>
ffffffffc0202c92:	00002617          	auipc	a2,0x2
ffffffffc0202c96:	c8660613          	addi	a2,a2,-890 # ffffffffc0204918 <commands+0x818>
ffffffffc0202c9a:	16f00593          	li	a1,367
ffffffffc0202c9e:	00002517          	auipc	a0,0x2
ffffffffc0202ca2:	17a50513          	addi	a0,a0,378 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202ca6:	fb4fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202caa:	00002697          	auipc	a3,0x2
ffffffffc0202cae:	6ce68693          	addi	a3,a3,1742 # ffffffffc0205378 <default_pmm_manager+0x6b0>
ffffffffc0202cb2:	00002617          	auipc	a2,0x2
ffffffffc0202cb6:	c6660613          	addi	a2,a2,-922 # ffffffffc0204918 <commands+0x818>
ffffffffc0202cba:	1b600593          	li	a1,438
ffffffffc0202cbe:	00002517          	auipc	a0,0x2
ffffffffc0202cc2:	15a50513          	addi	a0,a0,346 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202cc6:	f94fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202cca:	00002697          	auipc	a3,0x2
ffffffffc0202cce:	67668693          	addi	a3,a3,1654 # ffffffffc0205340 <default_pmm_manager+0x678>
ffffffffc0202cd2:	00002617          	auipc	a2,0x2
ffffffffc0202cd6:	c4660613          	addi	a2,a2,-954 # ffffffffc0204918 <commands+0x818>
ffffffffc0202cda:	1b300593          	li	a1,435
ffffffffc0202cde:	00002517          	auipc	a0,0x2
ffffffffc0202ce2:	13a50513          	addi	a0,a0,314 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202ce6:	f74fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202cea:	00002697          	auipc	a3,0x2
ffffffffc0202cee:	62668693          	addi	a3,a3,1574 # ffffffffc0205310 <default_pmm_manager+0x648>
ffffffffc0202cf2:	00002617          	auipc	a2,0x2
ffffffffc0202cf6:	c2660613          	addi	a2,a2,-986 # ffffffffc0204918 <commands+0x818>
ffffffffc0202cfa:	1af00593          	li	a1,431
ffffffffc0202cfe:	00002517          	auipc	a0,0x2
ffffffffc0202d02:	11a50513          	addi	a0,a0,282 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202d06:	f54fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202d0a:	00002697          	auipc	a3,0x2
ffffffffc0202d0e:	5be68693          	addi	a3,a3,1470 # ffffffffc02052c8 <default_pmm_manager+0x600>
ffffffffc0202d12:	00002617          	auipc	a2,0x2
ffffffffc0202d16:	c0660613          	addi	a2,a2,-1018 # ffffffffc0204918 <commands+0x818>
ffffffffc0202d1a:	1ae00593          	li	a1,430
ffffffffc0202d1e:	00002517          	auipc	a0,0x2
ffffffffc0202d22:	0fa50513          	addi	a0,a0,250 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202d26:	f34fd0ef          	jal	ra,ffffffffc020045a <__panic>
    boot_pgdir_pa = PADDR(boot_pgdir_va);
ffffffffc0202d2a:	00002617          	auipc	a2,0x2
ffffffffc0202d2e:	07e60613          	addi	a2,a2,126 # ffffffffc0204da8 <default_pmm_manager+0xe0>
ffffffffc0202d32:	0cb00593          	li	a1,203
ffffffffc0202d36:	00002517          	auipc	a0,0x2
ffffffffc0202d3a:	0e250513          	addi	a0,a0,226 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202d3e:	f1cfd0ef          	jal	ra,ffffffffc020045a <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202d42:	00002617          	auipc	a2,0x2
ffffffffc0202d46:	06660613          	addi	a2,a2,102 # ffffffffc0204da8 <default_pmm_manager+0xe0>
ffffffffc0202d4a:	08000593          	li	a1,128
ffffffffc0202d4e:	00002517          	auipc	a0,0x2
ffffffffc0202d52:	0ca50513          	addi	a0,a0,202 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202d56:	f04fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert((ptep = get_pte(boot_pgdir_va, 0x0, 0)) != NULL);
ffffffffc0202d5a:	00002697          	auipc	a3,0x2
ffffffffc0202d5e:	23e68693          	addi	a3,a3,574 # ffffffffc0204f98 <default_pmm_manager+0x2d0>
ffffffffc0202d62:	00002617          	auipc	a2,0x2
ffffffffc0202d66:	bb660613          	addi	a2,a2,-1098 # ffffffffc0204918 <commands+0x818>
ffffffffc0202d6a:	16e00593          	li	a1,366
ffffffffc0202d6e:	00002517          	auipc	a0,0x2
ffffffffc0202d72:	0aa50513          	addi	a0,a0,170 # ffffffffc0204e18 <default_pmm_manager+0x150>
ffffffffc0202d76:	ee4fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(page_insert(boot_pgdir_va, p1, 0x0, 0) == 0);
ffffffffc0202d7a:	00002697          	auipc	a3,0x2
ffffffffc0202d7e:	1ee68693          	addi	a3,a3,494 # ffffffffc0204f68 <default_pmm_manager+0x2a0>
ffffffffc0202d82:	00002617          	auipc	a2,0x2
ffffffffc0202d86:	b9660613          	addi	a2,a2,-1130 # ffffffffc0204918 <commands+0x818>
ffffffffc0202d8a:	16b00593          	li	a1,363
ffffffffc0202d8e:	00002517          	auipc	a0,0x2
ffffffffc0202d92:	08a50513          	addi	a0,a0,138 # ffffffffc0204e18 <default_pmm_manager+0x150>
...
ffffffffc0202da0:	62468693          	addi	a3,a3,1572 # ffffffffc02053c0 <default_pmm_manager+0x6f8>
ffffffffc0202da4:	00002617          	auipc	a2,0x2
ffffffffc0202da8:	b7460613          	addi	a2,a2,-1164 # ffffffffc0204918 <commands+0x818>
ffffffffc0202dac:	08800593          	li	a1,136
ffffffffc0202db0:	00002517          	auipc	a0,0x2
ffffffffc0202db4:	63050513          	addi	a0,a0,1584 # ffffffffc02053e0 <default_pmm_manager+0x718>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next)
...
ffffffffc0202e72:	58268693          	addi	a3,a3,1410 # ffffffffc02053f0 <default_pmm_manager+0x728>
ffffffffc0202e76:	00002617          	auipc	a2,0x2
ffffffffc0202e7a:	aa260613          	addi	a2,a2,-1374 # ffffffffc0204918 <commands+0x818>
ffffffffc0202e7e:	08e00593          	li	a1,142
ffffffffc0202e82:	00002517          	auipc	a0,0x2
ffffffffc0202e86:	55e50513          	addi	a0,a0,1374 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0202e8a:	dd0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0202e8e:	00002697          	auipc	a3,0x2
ffffffffc0202e92:	5a268693          	addi	a3,a3,1442 # ffffffffc0205430 <default_pmm_manager+0x768>
ffffffffc0202e96:	00002617          	auipc	a2,0x2
ffffffffc0202e9a:	a8260613          	addi	a2,a2,-1406 # ffffffffc0204918 <commands+0x818>
ffffffffc0202e9e:	08700593          	li	a1,135
ffffffffc0202ea2:	00002517          	auipc	a0,0x2
ffffffffc0202ea6:	53e50513          	addi	a0,a0,1342 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0202eaa:	db0fd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0202eae:	00002697          	auipc	a3,0x2
ffffffffc0202eb2:	56268693          	addi	a3,a3,1378 # ffffffffc0205410 <default_pmm_manager+0x748>
ffffffffc0202eb6:	00002617          	auipc	a2,0x2
ffffffffc0202eba:	a6260613          	addi	a2,a2,-1438 # ffffffffc0204918 <commands+0x818>
ffffffffc0202ebe:	08600593          	li	a1,134
ffffffffc0202ec2:	00002517          	auipc	a0,0x2
ffffffffc0202ec6:	51e50513          	addi	a0,a0,1310 # ffffffffc02053e0 <default_pmm_manager+0x718>
...
ffffffffc0202f2c:	6a068693          	addi	a3,a3,1696 # ffffffffc02055c8 <default_pmm_manager+0x900>
ffffffffc0202f30:	00002617          	auipc	a2,0x2
ffffffffc0202f34:	9e860613          	addi	a2,a2,-1560 # ffffffffc0204918 <commands+0x818>
ffffffffc0202f38:	0da00593          	li	a1,218
ffffffffc0202f3c:	00002517          	auipc	a0,0x2
ffffffffc0202f40:	4a450513          	addi	a0,a0,1188 # ffffffffc02053e0 <default_pmm_manager+0x718>
...
ffffffffc0202f7a:	65268693          	addi	a3,a3,1618 # ffffffffc02055c8 <default_pmm_manager+0x900>
ffffffffc0202f7e:	00002617          	auipc	a2,0x2
ffffffffc0202f82:	99a60613          	addi	a2,a2,-1638 # ffffffffc0204918 <commands+0x818>
ffffffffc0202f86:	0e100593          	li	a1,225
ffffffffc0202f8a:	00002517          	auipc	a0,0x2
ffffffffc0202f8e:	45650513          	addi	a0,a0,1110 # ffffffffc02053e0 <default_pmm_manager+0x718>
...
ffffffffc020304e:	50650513          	addi	a0,a0,1286 # ffffffffc0205550 <default_pmm_manager+0x888>
ffffffffc0203052:	942fd0ef          	jal	ra,ffffffffc0200194 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203056:	00002697          	auipc	a3,0x2
ffffffffc020305a:	52268693          	addi	a3,a3,1314 # ffffffffc0205578 <default_pmm_manager+0x8b0>
ffffffffc020305e:	00002617          	auipc	a2,0x2
ffffffffc0203062:	8ba60613          	addi	a2,a2,-1862 # ffffffffc0204918 <commands+0x818>
ffffffffc0203066:	10700593          	li	a1,263
ffffffffc020306a:	00002517          	auipc	a0,0x2
ffffffffc020306e:	37650513          	addi	a0,a0,886 # ffffffffc02053e0 <default_pmm_manager+0x718>
...
ffffffffc02030a0:	4f450513          	addi	a0,a0,1268 # ffffffffc0205590 <default_pmm_manager+0x8c8>
...
ffffffffc02030ba:	4fa50513          	addi	a0,a0,1274 # ffffffffc02055b0 <default_pmm_manager+0x8e8>
}
...
ffffffffc02030c8:	3a468693          	addi	a3,a3,932 # ffffffffc0205468 <default_pmm_manager+0x7a0>
ffffffffc02030cc:	00002617          	auipc	a2,0x2
ffffffffc02030d0:	84c60613          	addi	a2,a2,-1972 # ffffffffc0204918 <commands+0x818>
ffffffffc02030d4:	0eb00593          	li	a1,235
ffffffffc02030d8:	00002517          	auipc	a0,0x2
ffffffffc02030dc:	30850513          	addi	a0,a0,776 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc02030e0:	b7afd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1->vm_start == i && vma1->vm_end == i + 2);
ffffffffc02030e4:	00002697          	auipc	a3,0x2
ffffffffc02030e8:	40c68693          	addi	a3,a3,1036 # ffffffffc02054f0 <default_pmm_manager+0x828>
ffffffffc02030ec:	00002617          	auipc	a2,0x2
ffffffffc02030f0:	82c60613          	addi	a2,a2,-2004 # ffffffffc0204918 <commands+0x818>
ffffffffc02030f4:	0fc00593          	li	a1,252
ffffffffc02030f8:	00002517          	auipc	a0,0x2
ffffffffc02030fc:	2e850513          	addi	a0,a0,744 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0203100:	b5afd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2->vm_start == i && vma2->vm_end == i + 2);
ffffffffc0203104:	00002697          	auipc	a3,0x2
ffffffffc0203108:	41c68693          	addi	a3,a3,1052 # ffffffffc0205520 <default_pmm_manager+0x858>
ffffffffc020310c:	00002617          	auipc	a2,0x2
ffffffffc0203110:	80c60613          	addi	a2,a2,-2036 # ffffffffc0204918 <commands+0x818>
ffffffffc0203114:	0fd00593          	li	a1,253
ffffffffc0203118:	00002517          	auipc	a0,0x2
ffffffffc020311c:	2c850513          	addi	a0,a0,712 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0203120:	b3afd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203124:	00002697          	auipc	a3,0x2
ffffffffc0203128:	32c68693          	addi	a3,a3,812 # ffffffffc0205450 <default_pmm_manager+0x788>
ffffffffc020312c:	00001617          	auipc	a2,0x1
ffffffffc0203130:	7ec60613          	addi	a2,a2,2028 # ffffffffc0204918 <commands+0x818>
ffffffffc0203134:	0e900593          	li	a1,233
ffffffffc0203138:	00002517          	auipc	a0,0x2
ffffffffc020313c:	2a850513          	addi	a0,a0,680 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0203140:	b1afd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma2 != NULL);
ffffffffc0203144:	00002697          	auipc	a3,0x2
ffffffffc0203148:	36c68693          	addi	a3,a3,876 # ffffffffc02054b0 <default_pmm_manager+0x7e8>
ffffffffc020314c:	00001617          	auipc	a2,0x1
ffffffffc0203150:	7cc60613          	addi	a2,a2,1996 # ffffffffc0204918 <commands+0x818>
ffffffffc0203154:	0f400593          	li	a1,244
ffffffffc0203158:	00002517          	auipc	a0,0x2
ffffffffc020315c:	28850513          	addi	a0,a0,648 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0203160:	afafd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma1 != NULL);
ffffffffc0203164:	00002697          	auipc	a3,0x2
ffffffffc0203168:	33c68693          	addi	a3,a3,828 # ffffffffc02054a0 <default_pmm_manager+0x7d8>
ffffffffc020316c:	00001617          	auipc	a2,0x1
ffffffffc0203170:	7ac60613          	addi	a2,a2,1964 # ffffffffc0204918 <commands+0x818>
ffffffffc0203174:	0f200593          	li	a1,242
ffffffffc0203178:	00002517          	auipc	a0,0x2
ffffffffc020317c:	26850513          	addi	a0,a0,616 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc0203180:	adafd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma3 == NULL);
ffffffffc0203184:	00002697          	auipc	a3,0x2
ffffffffc0203188:	33c68693          	addi	a3,a3,828 # ffffffffc02054c0 <default_pmm_manager+0x7f8>
ffffffffc020318c:	00001617          	auipc	a2,0x1
ffffffffc0203190:	78c60613          	addi	a2,a2,1932 # ffffffffc0204918 <commands+0x818>
ffffffffc0203194:	0f600593          	li	a1,246
ffffffffc0203198:	00002517          	auipc	a0,0x2
ffffffffc020319c:	24850513          	addi	a0,a0,584 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc02031a0:	abafd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma5 == NULL);
ffffffffc02031a4:	00002697          	auipc	a3,0x2
ffffffffc02031a8:	33c68693          	addi	a3,a3,828 # ffffffffc02054e0 <default_pmm_manager+0x818>
ffffffffc02031ac:	00001617          	auipc	a2,0x1
ffffffffc02031b0:	76c60613          	addi	a2,a2,1900 # ffffffffc0204918 <commands+0x818>
ffffffffc02031b4:	0fa00593          	li	a1,250
ffffffffc02031b8:	00002517          	auipc	a0,0x2
ffffffffc02031bc:	22850513          	addi	a0,a0,552 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc02031c0:	a9afd0ef          	jal	ra,ffffffffc020045a <__panic>
        assert(vma4 == NULL);
ffffffffc02031c4:	00002697          	auipc	a3,0x2
ffffffffc02031c8:	30c68693          	addi	a3,a3,780 # ffffffffc02054d0 <default_pmm_manager+0x808>
ffffffffc02031cc:	00001617          	auipc	a2,0x1
ffffffffc02031d0:	74c60613          	addi	a2,a2,1868 # ffffffffc0204918 <commands+0x818>
ffffffffc02031d4:	0f800593          	li	a1,248
ffffffffc02031d8:	00002517          	auipc	a0,0x2
ffffffffc02031dc:	20850513          	addi	a0,a0,520 # ffffffffc02053e0 <default_pmm_manager+0x718>
ffffffffc02031e0:	a7afd0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(mm != NULL);
ffffffffc02031e4:	00002697          	auipc	a3,0x2
ffffffffc02031e8:	3f468693          	addi	a3,a3,1012 # ffffffffc02055d8 <default_pmm_manager+0x910>
ffffffffc02031ec:	00001617          	auipc	a2,0x1
ffffffffc02031f0:	72c60613          	addi	a2,a2,1836 # ffffffffc0204918 <commands+0x818>
ffffffffc02031f4:	0d200593          	li	a1,210
ffffffffc02031f8:	00002517          	auipc	a0,0x2
ffffffffc02031fc:	1e850513          	addi	a0,a0,488 # ffffffffc02053e0 <default_pmm_manager+0x718>
...
ffffffffc0203206:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203208:	3e4000ef          	jal	ra,ffffffffc02035ec <do_exit>
...
ffffffffc020321a:	842a                	mv	s0,a0
    if (proc != NULL)
ffffffffc020321c:	cd21                	beqz	a0,ffffffffc0203274 <alloc_proc+0x68>
...
ffffffffc0203242:	407000ef          	jal	ra,ffffffffc0203e48 <memset>
...
ffffffffc020324e:	f45c                	sd	a5,168(s0)
        proc->tf = NULL;                    // 中断帧暂设为NULL（后续copy_thread构造）
ffffffffc0203250:	0a043023          	sd	zero,160(s0)
...
ffffffffc0203260:	3e9000ef          	jal	ra,ffffffffc0203e48 <memset>
        list_init(&proc->list_link);        // 初始化进程链表节点
ffffffffc0203264:	0c840713          	addi	a4,s0,200
        list_init(&proc->hash_link);        // 初始化进程哈希表节点
ffffffffc0203268:	0d840793          	addi	a5,s0,216
    elm->prev = elm->next = elm;
ffffffffc020326c:	e878                	sd	a4,208(s0)
ffffffffc020326e:	e478                	sd	a4,200(s0)
ffffffffc0203270:	f07c                	sd	a5,224(s0)
ffffffffc0203272:	ec7c                	sd	a5,216(s0)
    }
    return proc;
}
...
ffffffffc0203288:	b4dfd06f          	j	ffffffffc0200dd4 <forkrets>
...
ffffffffc02032da:	33a50513          	addi	a0,a0,826 # ffffffffc0205610 <default_pmm_manager+0x948>
ffffffffc02032de:	eb7fc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02032e2:	00002517          	auipc	a0,0x2
ffffffffc02032e6:	33e50513          	addi	a0,a0,830 # ffffffffc0205620 <default_pmm_manager+0x958>
...
ffffffffc020333e:	534000ef          	jal	ra,ffffffffc0203872 <switch_to>
    if (flag) {
...
ffffffffc0203384:	1cf75963          	bge	a4,a5,ffffffffc0203556 <do_fork+0x1ea>
ffffffffc0203388:	892e                	mv	s2,a1
ffffffffc020338a:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc020338c:	e81ff0ef          	jal	ra,ffffffffc020320c <alloc_proc>
ffffffffc0203390:	89aa                	mv	s3,a0
    if (!proc) {
ffffffffc0203392:	1c050763          	beqz	a0,ffffffffc0203560 <do_fork+0x1f4>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203396:	4509                	li	a0,2
ffffffffc0203398:	8fdfe0ef          	jal	ra,ffffffffc0201c94 <alloc_pages>
    if (page != NULL)
ffffffffc020339c:	1a050863          	beqz	a0,ffffffffc020354c <do_fork+0x1e0>
    return page - pages + nbase;
ffffffffc02033a0:	0000a697          	auipc	a3,0xa
ffffffffc02033a4:	1186b683          	ld	a3,280(a3) # ffffffffc020d4b8 <pages>
ffffffffc02033a8:	40d506b3          	sub	a3,a0,a3
ffffffffc02033ac:	8699                	srai	a3,a3,0x6
ffffffffc02033ae:	00002517          	auipc	a0,0x2
ffffffffc02033b2:	63253503          	ld	a0,1586(a0) # ffffffffc02059e0 <nbase>
...
ffffffffc02033c2:	0f273703          	ld	a4,242(a4) # ffffffffc020d4b0 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02033c6:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02033c8:	1ae7fe63          	bgeu	a5,a4,ffffffffc0203584 <do_fork+0x218>
    assert(current->mm == NULL);
ffffffffc02033cc:	0000a797          	auipc	a5,0xa
ffffffffc02033d0:	1047b783          	ld	a5,260(a5) # ffffffffc020d4d0 <current>
...
ffffffffc02033e0:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02033e4:	18079063          	bnez	a5,ffffffffc0203564 <do_fork+0x1f8>
...
ffffffffc0203420:	10090963          	beqz	s2,ffffffffc0203532 <do_fork+0x1c6>
    if (++last_pid >= MAX_PID)
ffffffffc0203424:	00006317          	auipc	t1,0x6
ffffffffc0203428:	c0430313          	addi	t1,t1,-1020 # ffffffffc0209028 <last_pid.1>
ffffffffc020342c:	00032783          	lw	a5,0(t1)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203430:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203434:	00000717          	auipc	a4,0x0
ffffffffc0203438:	e4a70713          	addi	a4,a4,-438 # ffffffffc020327e <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc020343c:	0017851b          	addiw	a0,a5,1
    return listelm->next;
ffffffffc0203440:	0000a617          	auipc	a2,0xa
ffffffffc0203444:	01860613          	addi	a2,a2,24 # ffffffffc020d458 <proc_list>
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203448:	02e9b823          	sd	a4,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc020344c:	02d9bc23          	sd	a3,56(s3)
    if (++last_pid >= MAX_PID)
ffffffffc0203450:	00a32023          	sw	a0,0(t1)
ffffffffc0203454:	6789                	lui	a5,0x2
ffffffffc0203456:	00863883          	ld	a7,8(a2)
ffffffffc020345a:	06f55a63          	bge	a0,a5,ffffffffc02034ce <do_fork+0x162>
    if (last_pid >= next_safe)
ffffffffc020345e:	00006e97          	auipc	t4,0x6
ffffffffc0203462:	bcee8e93          	addi	t4,t4,-1074 # ffffffffc020902c <next_safe.0>
ffffffffc0203466:	000ea783          	lw	a5,0(t4)
ffffffffc020346a:	06f55a63          	bge	a0,a5,ffffffffc02034de <do_fork+0x172>
...
ffffffffc0203472:	0c898793          	addi	a5,s3,200
    prev->next = next->prev = elm;
ffffffffc0203476:	00f8b023          	sd	a5,0(a7)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020347a:	45a9                	li	a1,10
    elm->next = next;
ffffffffc020347c:	0d19b823          	sd	a7,208(s3)
    elm->prev = prev;
ffffffffc0203480:	0cc9b423          	sd	a2,200(s3)
ffffffffc0203484:	2501                	sext.w	a0,a0
    prev->next = next->prev = elm;
ffffffffc0203486:	e61c                	sd	a5,8(a2)
ffffffffc0203488:	51a000ef          	jal	ra,ffffffffc02039a2 <hash32>
ffffffffc020348c:	02051793          	slli	a5,a0,0x20
ffffffffc0203490:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0203494:	00006797          	auipc	a5,0x6
ffffffffc0203498:	fb478793          	addi	a5,a5,-76 # ffffffffc0209448 <hash_list>
ffffffffc020349c:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc020349e:	6518                	ld	a4,8(a0)
    nr_process++; // 全局进程计数 +1
ffffffffc02034a0:	409c                	lw	a5,0(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc02034a2:	0d898693          	addi	a3,s3,216
    prev->next = next->prev = elm;
ffffffffc02034a6:	e314                	sd	a3,0(a4)
ffffffffc02034a8:	e514                	sd	a3,8(a0)
    nr_process++; // 全局进程计数 +1
ffffffffc02034aa:	2785                	addiw	a5,a5,1
    elm->prev = prev;
ffffffffc02034ac:	0ca9bc23          	sd	a0,216(s3)
    elm->next = next;
ffffffffc02034b0:	0ee9b023          	sd	a4,224(s3)
    wakeup_proc(proc);
ffffffffc02034b4:	854e                	mv	a0,s3
    nr_process++; // 全局进程计数 +1
ffffffffc02034b6:	c09c                	sw	a5,0(s1)
    wakeup_proc(proc);
ffffffffc02034b8:	424000ef          	jal	ra,ffffffffc02038dc <wakeup_proc>
    ret = proc->pid;
ffffffffc02034bc:	0049a503          	lw	a0,4(s3)
}
...
ffffffffc02034ca:	6145                	addi	sp,sp,48
ffffffffc02034cc:	8082                	ret
        last_pid = 1;
ffffffffc02034ce:	4785                	li	a5,1
ffffffffc02034d0:	00f32023          	sw	a5,0(t1)
        goto inside;
ffffffffc02034d4:	4505                	li	a0,1
ffffffffc02034d6:	00006e97          	auipc	t4,0x6
ffffffffc02034da:	b56e8e93          	addi	t4,t4,-1194 # ffffffffc020902c <next_safe.0>
        next_safe = MAX_PID;
ffffffffc02034de:	6789                	lui	a5,0x2
ffffffffc02034e0:	00fea023          	sw	a5,0(t4)
ffffffffc02034e4:	86aa                	mv	a3,a0
ffffffffc02034e6:	4801                	li	a6,0
        while ((le = list_next(le)) != list)
ffffffffc02034e8:	6f09                	lui	t5,0x2
ffffffffc02034ea:	04c88b63          	beq	a7,a2,ffffffffc0203540 <do_fork+0x1d4>
ffffffffc02034ee:	8e42                	mv	t3,a6
ffffffffc02034f0:	87c6                	mv	a5,a7
ffffffffc02034f2:	6589                	lui	a1,0x2
ffffffffc02034f4:	a811                	j	ffffffffc0203508 <do_fork+0x19c>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc02034f6:	00e6d663          	bge	a3,a4,ffffffffc0203502 <do_fork+0x196>
ffffffffc02034fa:	00b75463          	bge	a4,a1,ffffffffc0203502 <do_fork+0x196>
ffffffffc02034fe:	85ba                	mv	a1,a4
ffffffffc0203500:	4e05                	li	t3,1
    return listelm->next;
ffffffffc0203502:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0203504:	00c78d63          	beq	a5,a2,ffffffffc020351e <do_fork+0x1b2>
            if (proc->pid == last_pid)
ffffffffc0203508:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020350c:	fed715e3          	bne	a4,a3,ffffffffc02034f6 <do_fork+0x18a>
                if (++last_pid >= next_safe)
ffffffffc0203510:	2685                	addiw	a3,a3,1
ffffffffc0203512:	02b6d263          	bge	a3,a1,ffffffffc0203536 <do_fork+0x1ca>
ffffffffc0203516:	679c                	ld	a5,8(a5)
ffffffffc0203518:	4805                	li	a6,1
        while ((le = list_next(le)) != list)
ffffffffc020351a:	fec797e3          	bne	a5,a2,ffffffffc0203508 <do_fork+0x19c>
ffffffffc020351e:	00080563          	beqz	a6,ffffffffc0203528 <do_fork+0x1bc>
ffffffffc0203522:	00d32023          	sw	a3,0(t1)
ffffffffc0203526:	8536                	mv	a0,a3
ffffffffc0203528:	f40e03e3          	beqz	t3,ffffffffc020346e <do_fork+0x102>
ffffffffc020352c:	00bea023          	sw	a1,0(t4)
ffffffffc0203530:	bf3d                	j	ffffffffc020346e <do_fork+0x102>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203532:	8936                	mv	s2,a3
ffffffffc0203534:	bdc5                	j	ffffffffc0203424 <do_fork+0xb8>
                    if (last_pid >= MAX_PID)
ffffffffc0203536:	01e6c363          	blt	a3,t5,ffffffffc020353c <do_fork+0x1d0>
                        last_pid = 1;
ffffffffc020353a:	4685                	li	a3,1
                    goto repeat;
ffffffffc020353c:	4805                	li	a6,1
ffffffffc020353e:	b775                	j	ffffffffc02034ea <do_fork+0x17e>
ffffffffc0203540:	00080d63          	beqz	a6,ffffffffc020355a <do_fork+0x1ee>
ffffffffc0203544:	00d32023          	sw	a3,0(t1)
    return last_pid;
ffffffffc0203548:	8536                	mv	a0,a3
ffffffffc020354a:	b715                	j	ffffffffc020346e <do_fork+0x102>
    kfree(proc);
ffffffffc020354c:	854e                	mv	a0,s3
ffffffffc020354e:	e18fe0ef          	jal	ra,ffffffffc0201b66 <kfree>
    ret = -E_NO_MEM;
ffffffffc0203552:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0203554:	b7b5                	j	ffffffffc02034c0 <do_fork+0x154>
    int ret = -E_NO_FREE_PROC;
ffffffffc0203556:	556d                	li	a0,-5
ffffffffc0203558:	b7a5                	j	ffffffffc02034c0 <do_fork+0x154>
    return last_pid;
ffffffffc020355a:	00032503          	lw	a0,0(t1)
ffffffffc020355e:	bf01                	j	ffffffffc020346e <do_fork+0x102>
    ret = -E_NO_MEM;
ffffffffc0203560:	5571                	li	a0,-4
ffffffffc0203562:	bfb9                	j	ffffffffc02034c0 <do_fork+0x154>
    assert(current->mm == NULL);
ffffffffc0203564:	00002697          	auipc	a3,0x2
ffffffffc0203568:	0dc68693          	addi	a3,a3,220 # ffffffffc0205640 <default_pmm_manager+0x978>
ffffffffc020356c:	00001617          	auipc	a2,0x1
ffffffffc0203570:	3ac60613          	addi	a2,a2,940 # ffffffffc0204918 <commands+0x818>
ffffffffc0203574:	12400593          	li	a1,292
ffffffffc0203578:	00002517          	auipc	a0,0x2
ffffffffc020357c:	0e050513          	addi	a0,a0,224 # ffffffffc0205658 <default_pmm_manager+0x990>
ffffffffc0203580:	edbfc0ef          	jal	ra,ffffffffc020045a <__panic>
ffffffffc0203584:	00001617          	auipc	a2,0x1
ffffffffc0203588:	77c60613          	addi	a2,a2,1916 # ffffffffc0204d00 <default_pmm_manager+0x38>
ffffffffc020358c:	07100593          	li	a1,113
ffffffffc0203590:	00001517          	auipc	a0,0x1
ffffffffc0203594:	79850513          	addi	a0,a0,1944 # ffffffffc0204d28 <default_pmm_manager+0x60>
ffffffffc0203598:	ec3fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020359c <kernel_thread>:
{
ffffffffc020359c:	7129                	addi	sp,sp,-320
ffffffffc020359e:	fa22                	sd	s0,304(sp)
ffffffffc02035a0:	f626                	sd	s1,296(sp)
ffffffffc02035a2:	f24a                	sd	s2,288(sp)
ffffffffc02035a4:	84ae                	mv	s1,a1
ffffffffc02035a6:	892a                	mv	s2,a0
ffffffffc02035a8:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035aa:	4581                	li	a1,0
ffffffffc02035ac:	12000613          	li	a2,288
ffffffffc02035b0:	850a                	mv	a0,sp
{
ffffffffc02035b2:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02035b4:	095000ef          	jal	ra,ffffffffc0203e48 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02035b8:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02035ba:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02035bc:	100027f3          	csrr	a5,sstatus
ffffffffc02035c0:	edd7f793          	andi	a5,a5,-291
ffffffffc02035c4:	1207e793          	ori	a5,a5,288
ffffffffc02035c8:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035ca:	860a                	mv	a2,sp
ffffffffc02035cc:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035d0:	00000797          	auipc	a5,0x0
ffffffffc02035d4:	c3478793          	addi	a5,a5,-972 # ffffffffc0203204 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035d8:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02035da:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02035dc:	d91ff0ef          	jal	ra,ffffffffc020336c <do_fork>
}
ffffffffc02035e0:	70f2                	ld	ra,312(sp)
ffffffffc02035e2:	7452                	ld	s0,304(sp)
ffffffffc02035e4:	74b2                	ld	s1,296(sp)
ffffffffc02035e6:	7912                	ld	s2,288(sp)
ffffffffc02035e8:	6131                	addi	sp,sp,320
ffffffffc02035ea:	8082                	ret

ffffffffc02035ec <do_exit>:
{
ffffffffc02035ec:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02035ee:	00002617          	auipc	a2,0x2
ffffffffc02035f2:	08260613          	addi	a2,a2,130 # ffffffffc0205670 <default_pmm_manager+0x9a8>
ffffffffc02035f6:	19100593          	li	a1,401
ffffffffc02035fa:	00002517          	auipc	a0,0x2
ffffffffc02035fe:	05e50513          	addi	a0,a0,94 # ffffffffc0205658 <default_pmm_manager+0x990>
{
ffffffffc0203602:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0203604:	e57fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc0203608 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and
//           - create the second kernel thread init_main
void proc_init(void)
{
ffffffffc0203608:	7179                	addi	sp,sp,-48
ffffffffc020360a:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc020360c:	0000a797          	auipc	a5,0xa
ffffffffc0203610:	e4c78793          	addi	a5,a5,-436 # ffffffffc020d458 <proc_list>
ffffffffc0203614:	f406                	sd	ra,40(sp)
ffffffffc0203616:	f022                	sd	s0,32(sp)
ffffffffc0203618:	e84a                	sd	s2,16(sp)
ffffffffc020361a:	e44e                	sd	s3,8(sp)
ffffffffc020361c:	00006497          	auipc	s1,0x6
ffffffffc0203620:	e2c48493          	addi	s1,s1,-468 # ffffffffc0209448 <hash_list>
ffffffffc0203624:	e79c                	sd	a5,8(a5)
ffffffffc0203626:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc0203628:	0000a717          	auipc	a4,0xa
ffffffffc020362c:	e2070713          	addi	a4,a4,-480 # ffffffffc020d448 <name.2>
ffffffffc0203630:	87a6                	mv	a5,s1
ffffffffc0203632:	e79c                	sd	a5,8(a5)
ffffffffc0203634:	e39c                	sd	a5,0(a5)
ffffffffc0203636:	07c1                	addi	a5,a5,16
ffffffffc0203638:	fef71de3          	bne	a4,a5,ffffffffc0203632 <proc_init+0x2a>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc020363c:	bd1ff0ef          	jal	ra,ffffffffc020320c <alloc_proc>
ffffffffc0203640:	0000a917          	auipc	s2,0xa
ffffffffc0203644:	e9890913          	addi	s2,s2,-360 # ffffffffc020d4d8 <idleproc>
ffffffffc0203648:	00a93023          	sd	a0,0(s2)
ffffffffc020364c:	18050d63          	beqz	a0,ffffffffc02037e6 <proc_init+0x1de>
    {
...
ffffffffc0203650:	07000513          	li	a0,112
ffffffffc0203654:	c62fe0ef          	jal	ra,ffffffffc0201ab6 <kmalloc>
...
ffffffffc020365e:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0203660:	7e8000ef          	jal	ra,ffffffffc0203e48 <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0203664:	00093503          	ld	a0,0(s2)
ffffffffc0203668:	85a2                	mv	a1,s0
ffffffffc020366a:	07000613          	li	a2,112
ffffffffc020366e:	03050513          	addi	a0,a0,48
ffffffffc0203672:	001000ef          	jal	ra,ffffffffc0203e72 <memcmp>
ffffffffc0203676:	89aa                	mv	s3,a0

    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203678:	453d                	li	a0,15
ffffffffc020367a:	c3cfe0ef          	jal	ra,ffffffffc0201ab6 <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020367e:	463d                	li	a2,15
ffffffffc0203680:	4581                	li	a1,0
    int *proc_name_mem = (int *)kmalloc(PROC_NAME_LEN);
ffffffffc0203682:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0203684:	7c4000ef          	jal	ra,ffffffffc0203e48 <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0203688:	00093503          	ld	a0,0(s2)
ffffffffc020368c:	463d                	li	a2,15
ffffffffc020368e:	85a2                	mv	a1,s0
ffffffffc0203690:	0b450513          	addi	a0,a0,180
ffffffffc0203694:	7de000ef          	jal	ra,ffffffffc0203e72 <memcmp>
...
ffffffffc0203698:	00093783          	ld	a5,0(s2)
ffffffffc020369c:	0000a717          	auipc	a4,0xa
ffffffffc02036a0:	e0473703          	ld	a4,-508(a4) # ffffffffc020d4a0 <boot_pgdir_pa>
ffffffffc02036a4:	77d4                	ld	a3,168(a5)
ffffffffc02036a6:	0ee68463          	beq	a3,a4,ffffffffc020378e <proc_init+0x186>
    {
...
ffffffffc02036aa:	4709                	li	a4,2
ffffffffc02036ac:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036ae:	00003717          	auipc	a4,0x3
ffffffffc02036b2:	95270713          	addi	a4,a4,-1710 # ffffffffc0206000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036b6:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02036ba:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02036bc:	4705                	li	a4,1
ffffffffc02036be:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02036c0:	4641                	li	a2,16
ffffffffc02036c2:	4581                	li	a1,0
ffffffffc02036c4:	8522                	mv	a0,s0
ffffffffc02036c6:	782000ef          	jal	ra,ffffffffc0203e48 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02036ca:	463d                	li	a2,15
ffffffffc02036cc:	00002597          	auipc	a1,0x2
ffffffffc02036d0:	fec58593          	addi	a1,a1,-20 # ffffffffc02056b8 <default_pmm_manager+0x9f0>
ffffffffc02036d4:	8522                	mv	a0,s0
ffffffffc02036d6:	784000ef          	jal	ra,ffffffffc0203e5a <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc02036da:	0000a717          	auipc	a4,0xa
ffffffffc02036de:	e0e70713          	addi	a4,a4,-498 # ffffffffc020d4e8 <nr_process>
ffffffffc02036e2:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02036e4:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036e8:	4601                	li	a2,0
    nr_process++;
ffffffffc02036ea:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02036ec:	00002597          	auipc	a1,0x2
ffffffffc02036f0:	fd458593          	addi	a1,a1,-44 # ffffffffc02056c0 <default_pmm_manager+0x9f8>
ffffffffc02036f4:	00000517          	auipc	a0,0x0
ffffffffc02036f8:	b9850513          	addi	a0,a0,-1128 # ffffffffc020328c <init_main>
    nr_process++;
ffffffffc02036fc:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02036fe:	0000a797          	auipc	a5,0xa
ffffffffc0203702:	dcd7b923          	sd	a3,-558(a5) # ffffffffc020d4d0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0203706:	e97ff0ef          	jal	ra,ffffffffc020359c <kernel_thread>
ffffffffc020370a:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc020370c:	0ea05963          	blez	a0,ffffffffc02037fe <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID)
ffffffffc0203710:	6789                	lui	a5,0x2
ffffffffc0203712:	fff5071b          	addiw	a4,a0,-1
ffffffffc0203716:	17f9                	addi	a5,a5,-2
ffffffffc0203718:	2501                	sext.w	a0,a0
ffffffffc020371a:	02e7e363          	bltu	a5,a4,ffffffffc0203740 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020371e:	45a9                	li	a1,10
ffffffffc0203720:	282000ef          	jal	ra,ffffffffc02039a2 <hash32>
ffffffffc0203724:	02051793          	slli	a5,a0,0x20
ffffffffc0203728:	01c7d693          	srli	a3,a5,0x1c
ffffffffc020372c:	96a6                	add	a3,a3,s1
ffffffffc020372e:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0203730:	a029                	j	ffffffffc020373a <proc_init+0x132>
            if (proc->pid == pid)
ffffffffc0203732:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc0203736:	0a870563          	beq	a4,s0,ffffffffc02037e0 <proc_init+0x1d8>
    return listelm->next;
ffffffffc020373a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc020373c:	fef69be3          	bne	a3,a5,ffffffffc0203732 <proc_init+0x12a>
    return NULL;
ffffffffc0203740:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203742:	0b478493          	addi	s1,a5,180
...
ffffffffc020374a:	0000a417          	auipc	s0,0xa
ffffffffc020374e:	d9640413          	addi	s0,s0,-618 # ffffffffc020d4e0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203752:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0203754:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0203756:	6f2000ef          	jal	ra,ffffffffc0203e48 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020375a:	463d                	li	a2,15
ffffffffc020375c:	00002597          	auipc	a1,0x2
ffffffffc0203760:	f9458593          	addi	a1,a1,-108 # ffffffffc02056f0 <default_pmm_manager+0xa28>
ffffffffc0203764:	8526                	mv	a0,s1
ffffffffc0203766:	6f4000ef          	jal	ra,ffffffffc0203e5a <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc020376a:	00093783          	ld	a5,0(s2)
ffffffffc020376e:	c7e1                	beqz	a5,ffffffffc0203836 <proc_init+0x22e>
ffffffffc0203770:	43dc                	lw	a5,4(a5)
ffffffffc0203772:	e3f1                	bnez	a5,ffffffffc0203836 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203774:	601c                	ld	a5,0(s0)
ffffffffc0203776:	c3c5                	beqz	a5,ffffffffc0203816 <proc_init+0x20e>
ffffffffc0203778:	43d8                	lw	a4,4(a5)
ffffffffc020377a:	4785                	li	a5,1
ffffffffc020377c:	08f71d63          	bne	a4,a5,ffffffffc0203816 <proc_init+0x20e>
}
ffffffffc0203780:	70a2                	ld	ra,40(sp)
ffffffffc0203782:	7402                	ld	s0,32(sp)
ffffffffc0203784:	64e2                	ld	s1,24(sp)
ffffffffc0203786:	6942                	ld	s2,16(sp)
ffffffffc0203788:	69a2                	ld	s3,8(sp)
ffffffffc020378a:	6145                	addi	sp,sp,48
ffffffffc020378c:	8082                	ret
    if (idleproc->pgdir == boot_pgdir_pa && idleproc->tf == NULL && !context_init_flag && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0 && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag)
ffffffffc020378e:	73d8                	ld	a4,160(a5)
ffffffffc0203790:	ff09                	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc0203792:	f0099ce3          	bnez	s3,ffffffffc02036aa <proc_init+0xa2>
ffffffffc0203796:	6394                	ld	a3,0(a5)
ffffffffc0203798:	577d                	li	a4,-1
ffffffffc020379a:	1702                	slli	a4,a4,0x20
ffffffffc020379c:	f0e697e3          	bne	a3,a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037a0:	4798                	lw	a4,8(a5)
ffffffffc02037a2:	f00714e3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037a6:	6b98                	ld	a4,16(a5)
ffffffffc02037a8:	f00711e3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037ac:	4f98                	lw	a4,24(a5)
ffffffffc02037ae:	2701                	sext.w	a4,a4
ffffffffc02037b0:	ee071de3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037b4:	7398                	ld	a4,32(a5)
ffffffffc02037b6:	ee071ae3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037ba:	7798                	ld	a4,40(a5)
ffffffffc02037bc:	ee0717e3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
ffffffffc02037c0:	0b07a703          	lw	a4,176(a5)
ffffffffc02037c4:	8d59                	or	a0,a0,a4
ffffffffc02037c6:	0005071b          	sext.w	a4,a0
ffffffffc02037ca:	ee0710e3          	bnez	a4,ffffffffc02036aa <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02037ce:	00002517          	auipc	a0,0x2
ffffffffc02037d2:	ed250513          	addi	a0,a0,-302 # ffffffffc02056a0 <default_pmm_manager+0x9d8>
ffffffffc02037d6:	9bffc0ef          	jal	ra,ffffffffc0200194 <cprintf>
    idleproc->pid = 0;
ffffffffc02037da:	00093783          	ld	a5,0(s2)
ffffffffc02037de:	b5f1                	j	ffffffffc02036aa <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02037e0:	f2878793          	addi	a5,a5,-216
ffffffffc02037e4:	bfb9                	j	ffffffffc0203742 <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc02037e6:	00002617          	auipc	a2,0x2
ffffffffc02037ea:	ea260613          	addi	a2,a2,-350 # ffffffffc0205688 <default_pmm_manager+0x9c0>
ffffffffc02037ee:	1ac00593          	li	a1,428
ffffffffc02037f2:	00002517          	auipc	a0,0x2
ffffffffc02037f6:	e6650513          	addi	a0,a0,-410 # ffffffffc0205658 <default_pmm_manager+0x990>
ffffffffc02037fa:	c61fc0ef          	jal	ra,ffffffffc020045a <__panic>
        panic("create init_main failed.\n");
ffffffffc02037fe:	00002617          	auipc	a2,0x2
ffffffffc0203802:	ed260613          	addi	a2,a2,-302 # ffffffffc02056d0 <default_pmm_manager+0xa08>
ffffffffc0203806:	1c900593          	li	a1,457
ffffffffc020380a:	00002517          	auipc	a0,0x2
ffffffffc020380e:	e4e50513          	addi	a0,a0,-434 # ffffffffc0205658 <default_pmm_manager+0x990>
ffffffffc0203812:	c49fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0203816:	00002697          	auipc	a3,0x2
ffffffffc020381a:	f0a68693          	addi	a3,a3,-246 # ffffffffc0205720 <default_pmm_manager+0xa58>
ffffffffc020381e:	00001617          	auipc	a2,0x1
ffffffffc0203822:	0fa60613          	addi	a2,a2,250 # ffffffffc0204918 <commands+0x818>
ffffffffc0203826:	1d000593          	li	a1,464
ffffffffc020382a:	00002517          	auipc	a0,0x2
ffffffffc020382e:	e2e50513          	addi	a0,a0,-466 # ffffffffc0205658 <default_pmm_manager+0x990>
ffffffffc0203832:	c29fc0ef          	jal	ra,ffffffffc020045a <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0203836:	00002697          	auipc	a3,0x2
ffffffffc020383a:	ec268693          	addi	a3,a3,-318 # ffffffffc02056f8 <default_pmm_manager+0xa30>
ffffffffc020383e:	00001617          	auipc	a2,0x1
ffffffffc0203842:	0da60613          	addi	a2,a2,218 # ffffffffc0204918 <commands+0x818>
ffffffffc0203846:	1cf00593          	li	a1,463
ffffffffc020384a:	00002517          	auipc	a0,0x2
ffffffffc020384e:	e0e50513          	addi	a0,a0,-498 # ffffffffc0205658 <default_pmm_manager+0x990>
ffffffffc0203852:	c09fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc0203856 <cpu_idle>:
...
ffffffffc020385c:	0000a417          	auipc	s0,0xa
ffffffffc0203860:	c7440413          	addi	s0,s0,-908 # ffffffffc020d4d0 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0203864:	6018                	ld	a4,0(s0)
ffffffffc0203866:	4f1c                	lw	a5,24(a4)
ffffffffc0203868:	2781                	sext.w	a5,a5
ffffffffc020386a:	dff5                	beqz	a5,ffffffffc0203866 <cpu_idle+0x10>
        {
            schedule();
ffffffffc020386c:	0a2000ef          	jal	ra,ffffffffc020390e <schedule>
ffffffffc0203870:	bfd5                	j	ffffffffc0203864 <cpu_idle+0xe>

ffffffffc0203872 <switch_to>:
.text
...
ffffffffc0203872:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0203876:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc020387a:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc020387c:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc020387e:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0203882:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0203886:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc020388a:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc020388e:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0203892:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0203896:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc020389a:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc020389e:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc02038a2:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc02038a6:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc02038aa:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc02038ae:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc02038b0:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc02038b2:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc02038b6:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc02038ba:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc02038be:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc02038c2:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc02038c6:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc02038ca:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc02038ce:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc02038d2:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc02038d6:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc02038da:	8082                	ret

ffffffffc02038dc <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc02038dc:	411c                	lw	a5,0(a0)
ffffffffc02038de:	4705                	li	a4,1
ffffffffc02038e0:	37f9                	addiw	a5,a5,-2
ffffffffc02038e2:	00f77563          	bgeu	a4,a5,ffffffffc02038ec <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02038e6:	4789                	li	a5,2
ffffffffc02038e8:	c11c                	sw	a5,0(a0)
ffffffffc02038ea:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02038ec:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02038ee:	00002697          	auipc	a3,0x2
ffffffffc02038f2:	e5a68693          	addi	a3,a3,-422 # ffffffffc0205748 <default_pmm_manager+0xa80>
ffffffffc02038f6:	00001617          	auipc	a2,0x1
ffffffffc02038fa:	02260613          	addi	a2,a2,34 # ffffffffc0204918 <commands+0x818>
ffffffffc02038fe:	45a5                	li	a1,9
ffffffffc0203900:	00002517          	auipc	a0,0x2
ffffffffc0203904:	e8850513          	addi	a0,a0,-376 # ffffffffc0205788 <default_pmm_manager+0xac0>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0203908:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020390a:	b51fc0ef          	jal	ra,ffffffffc020045a <__panic>

ffffffffc020390e <schedule>:
}
...
ffffffffc0203912:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0203914:	100027f3          	csrr	a5,sstatus
ffffffffc0203918:	8b89                	andi	a5,a5,2
ffffffffc020391a:	4401                	li	s0,0
ffffffffc020391c:	efbd                	bnez	a5,ffffffffc020399a <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0203922:	bb28b883          	ld	a7,-1102(a7) # ffffffffc020d4d0 <current>
ffffffffc0203926:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020392a:	0000a517          	auipc	a0,0xa
ffffffffc020392e:	bae53503          	ld	a0,-1106(a0) # ffffffffc020d4d8 <idleproc>
ffffffffc0203932:	04a88e63          	beq	a7,a0,ffffffffc020398e <schedule+0x80>
...
ffffffffc0203948:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc020394a:	00c78863          	beq	a5,a2,ffffffffc020395a <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc020394e:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0203952:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0203956:	03070163          	beq	a4,a6,ffffffffc0203978 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc020395a:	fef697e3          	bne	a3,a5,ffffffffc0203948 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc020395e:	ed89                	bnez	a1,ffffffffc0203978 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc0203964:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0203966:	00a88463          	beq	a7,a0,ffffffffc020396e <schedule+0x60>
            proc_run(next);
ffffffffc020396a:	995ff0ef          	jal	ra,ffffffffc02032fe <proc_run>
    if (flag) {
ffffffffc020396e:	e819                	bnez	s0,ffffffffc0203984 <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0203976:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0203978:	4198                	lw	a4,0(a1)
ffffffffc020397a:	4789                	li	a5,2
ffffffffc020397c:	fef712e3          	bne	a4,a5,ffffffffc0203960 <schedule+0x52>
ffffffffc0203980:	852e                	mv	a0,a1
ffffffffc0203982:	bff9                	j	ffffffffc0203960 <schedule+0x52>
}
ffffffffc0203984:	6402                	ld	s0,0(sp)
ffffffffc0203986:	60a2                	ld	ra,8(sp)
ffffffffc0203988:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc020398a:	fa1fc06f          	j	ffffffffc020092a <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020398e:	0000a617          	auipc	a2,0xa
ffffffffc0203992:	aca60613          	addi	a2,a2,-1334 # ffffffffc020d458 <proc_list>
ffffffffc0203996:	86b2                	mv	a3,a2
ffffffffc0203998:	b76d                	j	ffffffffc0203942 <schedule+0x34>
        intr_disable();
ffffffffc020399a:	f97fc0ef          	jal	ra,ffffffffc0200930 <intr_disable>
        return 1;
ffffffffc020399e:	4405                	li	s0,1
ffffffffc02039a0:	bfbd                	j	ffffffffc020391e <schedule+0x10>

ffffffffc02039a2 <hash32>:
 *
...
ffffffffc02039a2:	9e3707b7          	lui	a5,0x9e370
ffffffffc02039a6:	2785                	addiw	a5,a5,1
ffffffffc02039a8:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02039ac:	02000793          	li	a5,32
ffffffffc02039b0:	9f8d                	subw	a5,a5,a1
}
ffffffffc02039b2:	00f5553b          	srlw	a0,a0,a5
ffffffffc02039b6:	8082                	ret

ffffffffc02039b8 <printnum>:
 * */
static void
...
ffffffffc02039b8:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039bc:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02039be:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039c2:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02039c4:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02039c8:	f022                	sd	s0,32(sp)
ffffffffc02039ca:	ec26                	sd	s1,24(sp)
ffffffffc02039cc:	e84a                	sd	s2,16(sp)
ffffffffc02039ce:	f406                	sd	ra,40(sp)
ffffffffc02039d0:	e44e                	sd	s3,8(sp)
ffffffffc02039d2:	84aa                	mv	s1,a0
ffffffffc02039d4:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc02039d6:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02039da:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02039dc:	03067e63          	bgeu	a2,a6,ffffffffc0203a18 <printnum+0x60>
ffffffffc02039e0:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02039e2:	00805763          	blez	s0,ffffffffc02039f0 <printnum+0x38>
ffffffffc02039e6:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02039e8:	85ca                	mv	a1,s2
ffffffffc02039ea:	854e                	mv	a0,s3
ffffffffc02039ec:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc02039ee:	fc65                	bnez	s0,ffffffffc02039e6 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02039f0:	1a02                	slli	s4,s4,0x20
ffffffffc02039f2:	00002797          	auipc	a5,0x2
ffffffffc02039f6:	dae78793          	addi	a5,a5,-594 # ffffffffc02057a0 <default_pmm_manager+0xad8>
ffffffffc02039fa:	020a5a13          	srli	s4,s4,0x20
ffffffffc02039fe:	9a3e                	add	s4,s4,a5
}
ffffffffc0203a00:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a02:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203a06:	70a2                	ld	ra,40(sp)
ffffffffc0203a08:	69a2                	ld	s3,8(sp)
ffffffffc0203a0a:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a0c:	85ca                	mv	a1,s2
ffffffffc0203a0e:	87a6                	mv	a5,s1
}
ffffffffc0203a10:	6942                	ld	s2,16(sp)
ffffffffc0203a12:	64e2                	ld	s1,24(sp)
ffffffffc0203a14:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203a16:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203a18:	03065633          	divu	a2,a2,a6
ffffffffc0203a1c:	8722                	mv	a4,s0
ffffffffc0203a1e:	f9bff0ef          	jal	ra,ffffffffc02039b8 <printnum>
ffffffffc0203a22:	b7f9                	j	ffffffffc02039f0 <printnum+0x38>

ffffffffc0203a24 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203a24:	7119                	addi	sp,sp,-128
ffffffffc0203a26:	f4a6                	sd	s1,104(sp)
ffffffffc0203a28:	f0ca                	sd	s2,96(sp)
ffffffffc0203a2a:	ecce                	sd	s3,88(sp)
ffffffffc0203a2c:	e8d2                	sd	s4,80(sp)
ffffffffc0203a2e:	e4d6                	sd	s5,72(sp)
ffffffffc0203a30:	e0da                	sd	s6,64(sp)
ffffffffc0203a32:	fc5e                	sd	s7,56(sp)
ffffffffc0203a34:	f06a                	sd	s10,32(sp)
ffffffffc0203a36:	fc86                	sd	ra,120(sp)
ffffffffc0203a38:	f8a2                	sd	s0,112(sp)
ffffffffc0203a3a:	f862                	sd	s8,48(sp)
ffffffffc0203a3c:	f466                	sd	s9,40(sp)
ffffffffc0203a3e:	ec6e                	sd	s11,24(sp)
ffffffffc0203a40:	892a                	mv	s2,a0
ffffffffc0203a42:	84ae                	mv	s1,a1
ffffffffc0203a44:	8d32                	mv	s10,a2
ffffffffc0203a46:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203a48:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203a4c:	5b7d                	li	s6,-1
ffffffffc0203a4e:	00002a97          	auipc	s5,0x2
ffffffffc0203a52:	d7ea8a93          	addi	s5,s5,-642 # ffffffffc02057cc <default_pmm_manager+0xb04>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203a56:	00002b97          	auipc	s7,0x2
ffffffffc0203a5a:	f52b8b93          	addi	s7,s7,-174 # ffffffffc02059a8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a5e:	000d4503          	lbu	a0,0(s10)
ffffffffc0203a62:	001d0413          	addi	s0,s10,1
ffffffffc0203a66:	01350a63          	beq	a0,s3,ffffffffc0203a7a <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203a6a:	c121                	beqz	a0,ffffffffc0203aaa <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203a6c:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a6e:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203a70:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203a72:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203a76:	ff351ae3          	bne	a0,s3,ffffffffc0203a6a <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a7a:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203a7e:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203a82:	4c81                	li	s9,0
ffffffffc0203a84:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203a86:	5c7d                	li	s8,-1
ffffffffc0203a88:	5dfd                	li	s11,-1
ffffffffc0203a8a:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203a8e:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203a90:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203a94:	0ff5f593          	zext.b	a1,a1
ffffffffc0203a98:	00140d13          	addi	s10,s0,1
ffffffffc0203a9c:	04b56263          	bltu	a0,a1,ffffffffc0203ae0 <vprintfmt+0xbc>
ffffffffc0203aa0:	058a                	slli	a1,a1,0x2
ffffffffc0203aa2:	95d6                	add	a1,a1,s5
ffffffffc0203aa4:	4194                	lw	a3,0(a1)
ffffffffc0203aa6:	96d6                	add	a3,a3,s5
ffffffffc0203aa8:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203aaa:	70e6                	ld	ra,120(sp)
ffffffffc0203aac:	7446                	ld	s0,112(sp)
ffffffffc0203aae:	74a6                	ld	s1,104(sp)
ffffffffc0203ab0:	7906                	ld	s2,96(sp)
ffffffffc0203ab2:	69e6                	ld	s3,88(sp)
ffffffffc0203ab4:	6a46                	ld	s4,80(sp)
ffffffffc0203ab6:	6aa6                	ld	s5,72(sp)
ffffffffc0203ab8:	6b06                	ld	s6,64(sp)
ffffffffc0203aba:	7be2                	ld	s7,56(sp)
ffffffffc0203abc:	7c42                	ld	s8,48(sp)
ffffffffc0203abe:	7ca2                	ld	s9,40(sp)
ffffffffc0203ac0:	7d02                	ld	s10,32(sp)
ffffffffc0203ac2:	6de2                	ld	s11,24(sp)
ffffffffc0203ac4:	6109                	addi	sp,sp,128
ffffffffc0203ac6:	8082                	ret
            padc = '0';
ffffffffc0203ac8:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0203aca:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ace:	846a                	mv	s0,s10
ffffffffc0203ad0:	00140d13          	addi	s10,s0,1
ffffffffc0203ad4:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203ad8:	0ff5f593          	zext.b	a1,a1
ffffffffc0203adc:	fcb572e3          	bgeu	a0,a1,ffffffffc0203aa0 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203ae0:	85a6                	mv	a1,s1
ffffffffc0203ae2:	02500513          	li	a0,37
ffffffffc0203ae6:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203ae8:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203aec:	8d22                	mv	s10,s0
ffffffffc0203aee:	f73788e3          	beq	a5,s3,ffffffffc0203a5e <vprintfmt+0x3a>
ffffffffc0203af2:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203af6:	1d7d                	addi	s10,s10,-1
ffffffffc0203af8:	ff379de3          	bne	a5,s3,ffffffffc0203af2 <vprintfmt+0xce>
ffffffffc0203afc:	b78d                	j	ffffffffc0203a5e <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0203afe:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0203b02:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b06:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203b08:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203b0c:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b10:	02d86463          	bltu	a6,a3,ffffffffc0203b38 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0203b14:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203b18:	002c169b          	slliw	a3,s8,0x2
ffffffffc0203b1c:	0186873b          	addw	a4,a3,s8
ffffffffc0203b20:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203b24:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0203b26:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0203b2a:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203b2c:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0203b30:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203b34:	fed870e3          	bgeu	a6,a3,ffffffffc0203b14 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0203b38:	f40ddce3          	bgez	s11,ffffffffc0203a90 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0203b3c:	8de2                	mv	s11,s8
ffffffffc0203b3e:	5c7d                	li	s8,-1
ffffffffc0203b40:	bf81                	j	ffffffffc0203a90 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0203b42:	fffdc693          	not	a3,s11
ffffffffc0203b46:	96fd                	srai	a3,a3,0x3f
ffffffffc0203b48:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b4c:	00144603          	lbu	a2,1(s0)
ffffffffc0203b50:	2d81                	sext.w	s11,s11
ffffffffc0203b52:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203b54:	bf35                	j	ffffffffc0203a90 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0203b56:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b5a:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203b5e:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203b60:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0203b62:	bfd9                	j	ffffffffc0203b38 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0203b64:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b66:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b6a:	01174463          	blt	a4,a7,ffffffffc0203b72 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0203b6e:	1a088e63          	beqz	a7,ffffffffc0203d2a <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0203b72:	000a3603          	ld	a2,0(s4)
ffffffffc0203b76:	46c1                	li	a3,16
ffffffffc0203b78:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203b7a:	2781                	sext.w	a5,a5
ffffffffc0203b7c:	876e                	mv	a4,s11
ffffffffc0203b7e:	85a6                	mv	a1,s1
ffffffffc0203b80:	854a                	mv	a0,s2
ffffffffc0203b82:	e37ff0ef          	jal	ra,ffffffffc02039b8 <printnum>
            break;
ffffffffc0203b86:	bde1                	j	ffffffffc0203a5e <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0203b88:	000a2503          	lw	a0,0(s4)
ffffffffc0203b8c:	85a6                	mv	a1,s1
ffffffffc0203b8e:	0a21                	addi	s4,s4,8
ffffffffc0203b90:	9902                	jalr	s2
            break;
ffffffffc0203b92:	b5f1                	j	ffffffffc0203a5e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203b94:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203b96:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203b9a:	01174463          	blt	a4,a7,ffffffffc0203ba2 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0203b9e:	18088163          	beqz	a7,ffffffffc0203d20 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0203ba2:	000a3603          	ld	a2,0(s4)
ffffffffc0203ba6:	46a9                	li	a3,10
ffffffffc0203ba8:	8a2e                	mv	s4,a1
ffffffffc0203baa:	bfc1                	j	ffffffffc0203b7a <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bac:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203bb0:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bb2:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bb4:	bdf1                	j	ffffffffc0203a90 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0203bb6:	85a6                	mv	a1,s1
ffffffffc0203bb8:	02500513          	li	a0,37
ffffffffc0203bbc:	9902                	jalr	s2
            break;
ffffffffc0203bbe:	b545                	j	ffffffffc0203a5e <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bc0:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0203bc4:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203bc6:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203bc8:	b5e1                	j	ffffffffc0203a90 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0203bca:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203bcc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0203bd0:	01174463          	blt	a4,a7,ffffffffc0203bd8 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0203bd4:	14088163          	beqz	a7,ffffffffc0203d16 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0203bd8:	000a3603          	ld	a2,0(s4)
ffffffffc0203bdc:	46a1                	li	a3,8
ffffffffc0203bde:	8a2e                	mv	s4,a1
ffffffffc0203be0:	bf69                	j	ffffffffc0203b7a <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0203be2:	03000513          	li	a0,48
ffffffffc0203be6:	85a6                	mv	a1,s1
ffffffffc0203be8:	e03e                	sd	a5,0(sp)
ffffffffc0203bea:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203bec:	85a6                	mv	a1,s1
ffffffffc0203bee:	07800513          	li	a0,120
ffffffffc0203bf2:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bf4:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0203bf6:	6782                	ld	a5,0(sp)
ffffffffc0203bf8:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203bfa:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0203bfe:	bfb5                	j	ffffffffc0203b7a <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c00:	000a3403          	ld	s0,0(s4)
ffffffffc0203c04:	008a0713          	addi	a4,s4,8
ffffffffc0203c08:	e03a                	sd	a4,0(sp)
ffffffffc0203c0a:	14040263          	beqz	s0,ffffffffc0203d4e <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0203c0e:	0fb05763          	blez	s11,ffffffffc0203cfc <vprintfmt+0x2d8>
ffffffffc0203c12:	02d00693          	li	a3,45
ffffffffc0203c16:	0cd79163          	bne	a5,a3,ffffffffc0203cd8 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c1a:	00044783          	lbu	a5,0(s0)
ffffffffc0203c1e:	0007851b          	sext.w	a0,a5
ffffffffc0203c22:	cf85                	beqz	a5,ffffffffc0203c5a <vprintfmt+0x236>
ffffffffc0203c24:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c28:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c2c:	000c4563          	bltz	s8,ffffffffc0203c36 <vprintfmt+0x212>
ffffffffc0203c30:	3c7d                	addiw	s8,s8,-1
ffffffffc0203c32:	036c0263          	beq	s8,s6,ffffffffc0203c56 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0203c36:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203c38:	0e0c8e63          	beqz	s9,ffffffffc0203d34 <vprintfmt+0x310>
ffffffffc0203c3c:	3781                	addiw	a5,a5,-32
ffffffffc0203c3e:	0ef47b63          	bgeu	s0,a5,ffffffffc0203d34 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0203c42:	03f00513          	li	a0,63
ffffffffc0203c46:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203c48:	000a4783          	lbu	a5,0(s4)
ffffffffc0203c4c:	3dfd                	addiw	s11,s11,-1
ffffffffc0203c4e:	0a05                	addi	s4,s4,1
ffffffffc0203c50:	0007851b          	sext.w	a0,a5
ffffffffc0203c54:	ffe1                	bnez	a5,ffffffffc0203c2c <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0203c56:	01b05963          	blez	s11,ffffffffc0203c68 <vprintfmt+0x244>
ffffffffc0203c5a:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203c5c:	85a6                	mv	a1,s1
ffffffffc0203c5e:	02000513          	li	a0,32
ffffffffc0203c62:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203c64:	fe0d9be3          	bnez	s11,ffffffffc0203c5a <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203c68:	6a02                	ld	s4,0(sp)
ffffffffc0203c6a:	bbd5                	j	ffffffffc0203a5e <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203c6c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0203c6e:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0203c72:	01174463          	blt	a4,a7,ffffffffc0203c7a <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0203c76:	08088d63          	beqz	a7,ffffffffc0203d10 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0203c7a:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0203c7e:	0a044d63          	bltz	s0,ffffffffc0203d38 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0203c82:	8622                	mv	a2,s0
ffffffffc0203c84:	8a66                	mv	s4,s9
ffffffffc0203c86:	46a9                	li	a3,10
ffffffffc0203c88:	bdcd                	j	ffffffffc0203b7a <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0203c8a:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c8e:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203c90:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0203c92:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203c96:	8fb5                	xor	a5,a5,a3
ffffffffc0203c98:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203c9c:	02d74163          	blt	a4,a3,ffffffffc0203cbe <vprintfmt+0x29a>
ffffffffc0203ca0:	00369793          	slli	a5,a3,0x3
ffffffffc0203ca4:	97de                	add	a5,a5,s7
ffffffffc0203ca6:	639c                	ld	a5,0(a5)
ffffffffc0203ca8:	cb99                	beqz	a5,ffffffffc0203cbe <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203caa:	86be                	mv	a3,a5
ffffffffc0203cac:	00000617          	auipc	a2,0x0
ffffffffc0203cb0:	21460613          	addi	a2,a2,532 # ffffffffc0203ec0 <etext+0x2a>
ffffffffc0203cb4:	85a6                	mv	a1,s1
ffffffffc0203cb6:	854a                	mv	a0,s2
ffffffffc0203cb8:	0ce000ef          	jal	ra,ffffffffc0203d86 <printfmt>
ffffffffc0203cbc:	b34d                	j	ffffffffc0203a5e <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0203cbe:	00002617          	auipc	a2,0x2
ffffffffc0203cc2:	b0260613          	addi	a2,a2,-1278 # ffffffffc02057c0 <default_pmm_manager+0xaf8>
ffffffffc0203cc6:	85a6                	mv	a1,s1
ffffffffc0203cc8:	854a                	mv	a0,s2
ffffffffc0203cca:	0bc000ef          	jal	ra,ffffffffc0203d86 <printfmt>
ffffffffc0203cce:	bb41                	j	ffffffffc0203a5e <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0203cd0:	00002417          	auipc	s0,0x2
ffffffffc0203cd4:	ae840413          	addi	s0,s0,-1304 # ffffffffc02057b8 <default_pmm_manager+0xaf0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cd8:	85e2                	mv	a1,s8
ffffffffc0203cda:	8522                	mv	a0,s0
ffffffffc0203cdc:	e43e                	sd	a5,8(sp)
ffffffffc0203cde:	0e2000ef          	jal	ra,ffffffffc0203dc0 <strnlen>
ffffffffc0203ce2:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0203ce6:	01b05b63          	blez	s11,ffffffffc0203cfc <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0203cea:	67a2                	ld	a5,8(sp)
ffffffffc0203cec:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cf0:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0203cf2:	85a6                	mv	a1,s1
ffffffffc0203cf4:	8552                	mv	a0,s4
ffffffffc0203cf6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0203cf8:	fe0d9ce3          	bnez	s11,ffffffffc0203cf0 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203cfc:	00044783          	lbu	a5,0(s0)
ffffffffc0203d00:	00140a13          	addi	s4,s0,1
ffffffffc0203d04:	0007851b          	sext.w	a0,a5
ffffffffc0203d08:	d3a5                	beqz	a5,ffffffffc0203c68 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d0a:	05e00413          	li	s0,94
ffffffffc0203d0e:	bf39                	j	ffffffffc0203c2c <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0203d10:	000a2403          	lw	s0,0(s4)
ffffffffc0203d14:	b7ad                	j	ffffffffc0203c7e <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0203d16:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d1a:	46a1                	li	a3,8
ffffffffc0203d1c:	8a2e                	mv	s4,a1
ffffffffc0203d1e:	bdb1                	j	ffffffffc0203b7a <vprintfmt+0x156>
ffffffffc0203d20:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d24:	46a9                	li	a3,10
ffffffffc0203d26:	8a2e                	mv	s4,a1
ffffffffc0203d28:	bd89                	j	ffffffffc0203b7a <vprintfmt+0x156>
ffffffffc0203d2a:	000a6603          	lwu	a2,0(s4)
ffffffffc0203d2e:	46c1                	li	a3,16
ffffffffc0203d30:	8a2e                	mv	s4,a1
ffffffffc0203d32:	b5a1                	j	ffffffffc0203b7a <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0203d34:	9902                	jalr	s2
ffffffffc0203d36:	bf09                	j	ffffffffc0203c48 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0203d38:	85a6                	mv	a1,s1
ffffffffc0203d3a:	02d00513          	li	a0,45
ffffffffc0203d3e:	e03e                	sd	a5,0(sp)
ffffffffc0203d40:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0203d42:	6782                	ld	a5,0(sp)
ffffffffc0203d44:	8a66                	mv	s4,s9
ffffffffc0203d46:	40800633          	neg	a2,s0
ffffffffc0203d4a:	46a9                	li	a3,10
ffffffffc0203d4c:	b53d                	j	ffffffffc0203b7a <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0203d4e:	03b05163          	blez	s11,ffffffffc0203d70 <vprintfmt+0x34c>
ffffffffc0203d52:	02d00693          	li	a3,45
ffffffffc0203d56:	f6d79de3          	bne	a5,a3,ffffffffc0203cd0 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0203d5a:	00002417          	auipc	s0,0x2
ffffffffc0203d5e:	a5e40413          	addi	s0,s0,-1442 # ffffffffc02057b8 <default_pmm_manager+0xaf0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203d62:	02800793          	li	a5,40
ffffffffc0203d66:	02800513          	li	a0,40
ffffffffc0203d6a:	00140a13          	addi	s4,s0,1
ffffffffc0203d6e:	bd6d                	j	ffffffffc0203c28 <vprintfmt+0x204>
ffffffffc0203d70:	00002a17          	auipc	s4,0x2
ffffffffc0203d74:	a49a0a13          	addi	s4,s4,-1463 # ffffffffc02057b9 <default_pmm_manager+0xaf1>
ffffffffc0203d78:	02800513          	li	a0,40
ffffffffc0203d7c:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203d80:	05e00413          	li	s0,94
ffffffffc0203d84:	b565                	j	ffffffffc0203c2c <vprintfmt+0x208>

ffffffffc0203d86 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d86:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0203d88:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d8c:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d8e:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0203d90:	ec06                	sd	ra,24(sp)
ffffffffc0203d92:	f83a                	sd	a4,48(sp)
ffffffffc0203d94:	fc3e                	sd	a5,56(sp)
ffffffffc0203d96:	e0c2                	sd	a6,64(sp)
ffffffffc0203d98:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0203d9a:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0203d9c:	c89ff0ef          	jal	ra,ffffffffc0203a24 <vprintfmt>
}
ffffffffc0203da0:	60e2                	ld	ra,24(sp)
ffffffffc0203da2:	6161                	addi	sp,sp,80
ffffffffc0203da4:	8082                	ret

ffffffffc0203da6 <strlen>:
...
strlen(const char *s) {
ffffffffc0203daa:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0203dac:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0203dae:	cb81                	beqz	a5,ffffffffc0203dbe <strlen+0x18>
        cnt ++;
ffffffffc0203db0:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0203db2:	00a707b3          	add	a5,a4,a0
ffffffffc0203db6:	0007c783          	lbu	a5,0(a5)
ffffffffc0203dba:	fbfd                	bnez	a5,ffffffffc0203db0 <strlen+0xa>
...
ffffffffc0203dc0:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dc2:	e589                	bnez	a1,ffffffffc0203dcc <strnlen+0xc>
ffffffffc0203dc4:	a811                	j	ffffffffc0203dd8 <strnlen+0x18>
        cnt ++;
ffffffffc0203dc6:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0203dc8:	00f58863          	beq	a1,a5,ffffffffc0203dd8 <strnlen+0x18>
ffffffffc0203dcc:	00f50733          	add	a4,a0,a5
ffffffffc0203dd0:	00074703          	lbu	a4,0(a4)
ffffffffc0203dd4:	fb6d                	bnez	a4,ffffffffc0203dc6 <strnlen+0x6>
ffffffffc0203dd6:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0203dd8:	852e                	mv	a0,a1
ffffffffc0203dda:	8082                	ret

ffffffffc0203ddc <strcpy>:
char *
...
ffffffffc0203de6:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0203dea:	fb75                	bnez	a4,ffffffffc0203dde <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0203df2:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203df6:	cb89                	beqz	a5,ffffffffc0203e08 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0203df8:	0505                	addi	a0,a0,1
ffffffffc0203dfa:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0203dfc:	fee789e3          	beq	a5,a4,ffffffffc0203dee <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e00:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0203e04:	9d19                	subw	a0,a0,a4
ffffffffc0203e06:	8082                	ret
ffffffffc0203e08:	4501                	li	a0,0
ffffffffc0203e0a:	bfed                	j	ffffffffc0203e04 <strcmp+0x16>

ffffffffc0203e0c <strncmp>:
...
ffffffffc0203e0c:	c20d                	beqz	a2,ffffffffc0203e2e <strncmp+0x22>
ffffffffc0203e0e:	962e                	add	a2,a2,a1
ffffffffc0203e10:	a031                	j	ffffffffc0203e1c <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0203e12:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e14:	00e79a63          	bne	a5,a4,ffffffffc0203e28 <strncmp+0x1c>
ffffffffc0203e18:	00b60b63          	beq	a2,a1,ffffffffc0203e2e <strncmp+0x22>
ffffffffc0203e1c:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0203e20:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0203e22:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0203e26:	f7f5                	bnez	a5,ffffffffc0203e12 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0203e28:	40e7853b          	subw	a0,a5,a4
}
...
ffffffffc0203e36:	c799                	beqz	a5,ffffffffc0203e44 <strchr+0x12>
        if (*s == c) {
ffffffffc0203e38:	00f58763          	beq	a1,a5,ffffffffc0203e46 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0203e3c:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0203e40:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0203e42:	fbfd                	bnez	a5,ffffffffc0203e38 <strchr+0x6>
    }
    return NULL;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0203e72:	c205                	beqz	a2,ffffffffc0203e92 <memcmp+0x20>
ffffffffc0203e74:	962e                	add	a2,a2,a1
ffffffffc0203e76:	a019                	j	ffffffffc0203e7c <memcmp+0xa>
ffffffffc0203e78:	00c58d63          	beq	a1,a2,ffffffffc0203e92 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0203e86:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0203e88:	fee788e3          	beq	a5,a4,ffffffffc0203e78 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
